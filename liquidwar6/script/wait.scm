...
(define lw6-wait-any-key
  (lambda ()
	...
	(while (not (or
		     ...
		     (c-lw6gui-joystick1-pop-button-fire dsp)
		     (c-lw6gui-joystick1-pop-button-fire2 dsp)
		     ...
		     (c-lw6gui-joystick2-pop-button-fire dsp)
		     (c-lw6gui-joystick2-pop-button-fire2 dsp)
