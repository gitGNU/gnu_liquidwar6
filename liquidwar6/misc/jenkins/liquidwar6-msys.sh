...
# This will build and check the program in an msys environment,
# it does not perform as many checks since msys is sort of...
# limited, but still it does at least compile the binary
