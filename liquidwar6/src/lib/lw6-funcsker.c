...
lw6_register_funcs_ker ()
{
   ...
   * In liquidwar6ker
   */
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_BUILD_GAME_STRUCT, 1, 0, 0, (SCM (*)())_scm_lw6ker_build_game_struct);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_BUILD_GAME_STATE, 1, 0, 0, (SCM (*)())_scm_lw6ker_build_game_state);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_SYNC_GAME_STATE, 2, 0, 0, (SCM (*)())_scm_lw6ker_sync_game_state);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_DUP_GAME_STATE, 2, 0, 0, (SCM (*)())_scm_lw6ker_dup_game_state);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GAME_STRUCT_CHECKSUM, 1, 0, 0, (SCM (*)())_scm_lw6ker_game_struct_checksum);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GAME_STATE_CHECKSUM, 1, 0, 0, (SCM (*)())_scm_lw6ker_game_state_checksum);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_REGISTER_NODE, 2, 0, 0, (SCM (*)())_scm_lw6ker_register_node);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_UNREGISTER_NODE, 2, 0, 0, (SCM (*)())_scm_lw6ker_unregister_node);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_NODE_EXISTS, 2, 0, 0, (SCM (*)())_scm_lw6ker_node_exists);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_ADD_CURSOR, 4, 0, 0, (SCM (*)())_scm_lw6ker_add_cursor);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_REMOVE_CURSOR, 3, 0, 0, (SCM (*)())_scm_lw6ker_remove_cursor);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_CURSOR_EXISTS, 2, 0, 0, (SCM (*)())_scm_lw6ker_cursor_exists);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_CURSOR, 2, 0, 0, (SCM (*)())_scm_lw6ker_get_cursor);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_SET_CURSOR, 5, 0, 0, (SCM (*)())_scm_lw6ker_set_cursor);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_DO_ROUND, 1, 0, 0, (SCM (*)())_scm_lw6ker_do_round);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_MOVES, 1, 0, 0, (SCM (*)())_scm_lw6ker_get_moves);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_SPREADS, 1, 0, 0, (SCM (*)())_scm_lw6ker_get_spreads);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_ROUNDS, 1, 0, 0, (SCM (*)())_scm_lw6ker_get_rounds);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_IS_OVER, 1, 0, 0, (SCM (*)())_scm_lw6ker_is_over);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_DID_CURSOR_WIN, 5, 0, 0, (SCM (*)())_scm_lw6ker_did_cursor_win);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_NB_COLORS, 1, 0, 0, (SCM (*)())_scm_lw6ker_get_nb_colors);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_NB_CURSORS, 1, 0, 0, (SCM (*)())_scm_lw6ker_get_nb_cursors);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6KER_GET_NB_NODES, 1, 0, 0, (SCM (*)())_scm_lw6ker_get_nb_nodes);
