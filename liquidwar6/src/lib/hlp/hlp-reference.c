...
#define _DEFAULT_TRUE "true"
#define _DEFAULT_FALSE "false"

#define POPULATE_VOID(SYS_CONTEXT,KEY,ABOUT) lw6sys_hash_set((SYS_CONTEXT),_references,(KEY),_new_reference((SYS_CONTEXT),LW6HLP_TYPE_VOID,(KEY),(ABOUT),NULL,0,0))
#define POPULATE_STR(SYS_CONTEXT,KEY,ABOUT,DEFAULT) lw6sys_hash_set((SYS_CONTEXT),_references,(KEY),_new_reference((SYS_CONTEXT),LW6HLP_TYPE_STR,(KEY),(ABOUT),(DEFAULT),0,0))
#define POPULATE_INT(SYS_CONTEXT,KEY,ABOUT,DEFAULT,MIN,MAX) lw6sys_hash_set((SYS_CONTEXT),_references,(KEY),_new_reference((SYS_CONTEXT),LW6HLP_TYPE_INT,(KEY),(ABOUT),LW6SYS_QUOTE(DEFAULT),(MIN),(MAX)))
#define POPULATE_FLOAT(SYS_CONTEXT,KEY,ABOUT,DEFAULT,MIN,MAX) lw6sys_hash_set((SYS_CONTEXT),_references,(KEY),_new_reference((SYS_CONTEXT),LW6HLP_TYPE_FLOAT,(KEY),(ABOUT),LW6SYS_QUOTE(DEFAULT),(MIN),(MAX)))
#define POPULATE_BOOL(SYS_CONTEXT,KEY,ABOUT,DEFAULT) lw6sys_hash_set((SYS_CONTEXT),_references,(KEY),_new_reference((SYS_CONTEXT),LW6HLP_TYPE_BOOL,(KEY),(ABOUT),_true_false(DEFAULT),0,0))
#define POPULATE_COLOR(SYS_CONTEXT,KEY,ABOUT,DEFAULT) lw6sys_hash_set((SYS_CONTEXT),_references,(KEY),_new_reference((SYS_CONTEXT),LW6HLP_TYPE_COLOR,(KEY),(ABOUT),(DEFAULT),0,0))
...
_new_reference (lw6sys_context_t * sys_context, lw6hlp_type_t type, const char *key, const char *about, const char *default_value, int min_value,
		int max_value)
{
...
static int
_populate_references (lw6sys_context_t * sys_context)
{
  int ret = 0;
   ...
   * Quick
   */
  POPULATE_VOID (sys_context, LW6DEF_HELP, _x_ ("Returns a short help for the program."));
  POPULATE_VOID (sys_context, LW6DEF_COPYRIGHT, _x_ ("Returns the copyright notice for the program."));
  POPULATE_VOID (sys_context, LW6DEF_VERSION, _x_ ("Returns the version of the program, as defined by the GNU Coding Standards."));
  POPULATE_VOID (sys_context, LW6DEF_TEST,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_DEFAULTS,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_LIST,
		 _x_
  ...
  POPULATE_STR (sys_context, LW6DEF_ABOUT,
		_x_
		...
		NULL);
  POPULATE_VOID (sys_context, LW6DEF_DEBUG,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_PEDIGREE,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_HOST, _x_ ("Display all known system host properties, including os and cpu informations."));
  POPULATE_VOID (sys_context, LW6DEF_AUDIT,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_MODULES,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_CREDITS, _x_ ("Gives hopefully extensive information on who contributed to the game."));
  /*
   * Advanced doc
   */
  POPULATE_VOID (sys_context, LW6DEF_LIST_QUICK, _x_ ("List quick help entries, this includes the GNU standard options and a few troubleshooting tools."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_DOC,
		 _x_ ("List documentation-related command line options. These commands allow you to list all the keywords related to a given domain."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_SHOW,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_LIST_PATH,
		 _x_ ("List parameters which allow you to override the defaults of the game, and force the game your own file paths and directories."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_PLAYERS, _x_ ("List player-related entries, that is to say 'who plays'."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_INPUT,
		 _x_ ("List input (AKA controls) related options. Use these to change keyboard, joystick and mouse settingds."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_GRAPHICS, _x_ ("List graphics options (resolution, fullscreen...)."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_SOUND, _x_ ("List sound options (volume...)."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_NETWORK, _x_ ("List network options."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_MAP, _x_ ("List map-related entries, excluding rules.xml, hints.xml and style.xml entries."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_MAP_RULES, _x_ ("List 'options.xml' entries. These parameters enable you to modify the gameplay."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_MAP_HINTS, _x_ ("List 'hints.xml' entries. These parameters enable you to modify the behavior of the map loader."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_MAP_STYLE, _x_ ("List 'style.xml' entries. These parameters enable you to modify the aspect of the game."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_MAP_TEAMS,
		 _x_ ("List 'teams.xml' entries. These parameters enable you to specify which teams should play on the map."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_FUNCS, _x_ ("List the C-functions which are exported to Guile, thus usable in scripts."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_HOOKS, _x_ ("List user-modifiable hooks."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_ADVANCED, _x_ ("List advanced options which can be used for fine-tuning the game."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_ALIASES, _x_ ("List the keyword aliases. These are here for convenience."));
  POPULATE_VOID (sys_context, LW6DEF_LIST_TEAM_COLORS, _x_ ("List the team colors, there should be 10 of them"));
  POPULATE_VOID (sys_context, LW6DEF_LIST_WEAPONS, _x_ ("List the available weapons."));
  POPULATE_VOID (sys_context, LW6DEF_EXAMPLE_RULES_XML,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_EXAMPLE_HINTS_XML,
		 _x_ ("Dumps on stdout an example hints.xml file. Such a file is normally shipped with the game. It is indeed generated using this command."));
  POPULATE_VOID (sys_context, LW6DEF_EXAMPLE_STYLE_XML,
		 _x_ ("Dumps on stdout an example style.xml file. Such a file is normally shipped with the game. It is indeed generated using this command."));
  POPULATE_VOID (sys_context, LW6DEF_EXAMPLE_TEAMS_XML,
		 _x_ ("Dumps on stdout an example teams.xml file. Such a file is normally shipped with the game. It is indeed generated using this command."));
  /*
   * Build values
   */
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_PACKAGE_TARNAME, _x_ ("Shows the package tarname, that is, liquidwar6."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_PACKAGE_NAME, _x_ ("Shows the package name, that is, 'Liquid War 6'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_PACKAGE_STRING, _x_ ("Shows the package string, that is, 'Liquid War 6 <version>"));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_PACKAGE_ID, _x_ ("Shows the package tarname with its version, that is, 'liquidwar6-<version>"));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_VERSION,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_CODENAME,
		 _x_ ("Shows the codename associated with this version, generally the name of someone famous who is war-related (a general, an emperor...)."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_VERSION_BASE,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_VERSION_MAJOR,
		 _x_ ("Shows the major version number. This is just used to differenciate alpha/beta releases (using 0) from stable releases (using 6)."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_VERSION_MINOR,
		 _x_ ("Shows the minor version number. This is manually increased at each significant, public release of the game."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_STAMP,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_MD5SUM,
		 _x_ ("Shows the MD5 checksum, which has been calculated from the C source files. Complementary with 'show-build-stamp'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_COPYRIGHT, _x_ ("Shows a very short copyright notice."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_LICENSE, _x_ ("Shows the license of the program (GNU GPL v3 or later)."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_HOME_URL, _x_ ("Shows the URL of the program, its homepage."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_BUGS_URL, _x_ ("Shows the URL to make bug reports."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_CONFIGURE_ARGS,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_GCC_VERSION, _x_ ("Returns the version of the GNU C compiler which was used to compile the program."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_CFLAGS,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_LDFLAGS,
		 _x_ ("Shows what value you should put in 'LDFLAGS' (environment variable) if you want to link programs against libliquidwar6."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_HOSTNAME, _x_ ("Shows the name of the host where the binary was compiled."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_DATE, _x_ ("Shows the date when the binary was compiled."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_TIME, _x_ ("Shows the time when the binary was compiled."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_HOST_CPU, _x_ ("Shows the host CPU, as defined by 'host_cpu' in GNU Autoconf."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENDIANNESS,
		 _x_ ("Returns the endianness. 'little' corresponds to x86-like systems, 'big' to ppc-like systems."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_POINTER_SIZE,
		 _x_ ("Returns the pointer size, in bytes. Should be 4 on 32-bit systems and 8 on 64-bit systems."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_X86, _x_ ("Tells wether the CPU belongs to x86 family."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_HOST_OS, _x_ ("Shows the host OS, as defined by 'host_os' in GNU Autoconf."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_GNU,
		 _x_ ("Returns 1 (true) if host OS is a GNU system, or at least has been considered as such when compiling, 0 (false) if not."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_UNIX,
		 _x_ ("Returns 1 (true) if host OS is a UNIX system, or at least has been considered as such when compiling, 0 (false) if not."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_MS_WINDOWS, _x_ ("Returns 1 (true) if host OS is Microsoft Windows, 0 (false) if not."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_MAC_OS_X, _x_ ("Returns 1 (true) if host OS is Mac OS X, 0 (false) if not."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_GP2X, _x_ ("Returns 1 (true) if host is a GP2X, 0 (false) if not."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_TOP_SRCDIR,
		 _x_ ("Shows the top source directory on the machine where the binary was compiled, as a (possibly) relative path."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ABS_SRCDIR,
		 _x_ ("Shows the top source directory on the machine where the binary was compiled, as an absolute path."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_PREFIX,
		 _x_ ("Shows the 'prefix' value as passed to the GNU Autoconf './configure' script when compiling the program. Default is '/usr/local'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_DATADIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_LIBDIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_INCLUDEDIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_LOCALEDIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_DOCDIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_CONSOLE,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_GTK,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_GL1,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_GLES2,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_SOFT,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_CACA,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_CSOUND,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_OGG,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_MOD_HTTP,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_OPENMP,
		 _x_ ("Shows wether the program was built with OpenMP support. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_OPTIMIZE,
		 _x_ ("Shows wether the 'optimize' option has been chosen when building the game. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_ALLINONE,
		 _x_ ("Shows wether the 'allinone' option has been chosen when building the game. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_FULLSTATIC,
		 _x_ ("Shows wether the 'fullstatic' option has been chosen when building the game. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_PARANOID,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_GPROF,
		 _x_ ("Shows wether the game was build with suitable informations for gprof. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_INSTRUMENT,
		 _x_ ("Shows wether the game was build with the '-finstrument-functions' GCC switch. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_PROFILER,
		 _x_ ("Shows wether the game was build with Google Profiler support. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_GCOV,
		 _x_ ("Shows wether the game was build with suitable informations for gcov. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_ENABLE_VALGRIND,
		 _x_ ("Shows wether the game was build with valgrind later use in mind. This depends on parameters passed to './configure'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_BUILD_BIN_ID,
		 _x_
   ...
   * Show default paths
   */
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_USER_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_CONFIG_FILE, _x_ ("Shows the default config file path. Default is '$HOME/.liquidwar6/config.xml'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_LOG_FILE, _x_ ("Shows the default log file path. Default is '$HOME/.liquidwar6/log.csv'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_PREFIX,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_MOD_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_DATA_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_MUSIC_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_MUSIC_PATH,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_MAP_DIR,
		 _x_ ("Shows the default map directory. This is where builtin maps are stored. Default is '/usr/local/share/liquidwar6-<version>/map'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_MAP_PATH,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DEFAULT_SCRIPT_FILE,
		 _x_
   ...
   * Show paths
   */
  POPULATE_VOID (sys_context, LW6DEF_SHOW_CWD, _x_ ("Shows the current working directory, the value that the pwd command would return."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_RUN_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_USER_DIR,
		 _x_ ("Shows the user directory path. This is where run-time data, config files, log files, are stored. Default is '$HOME/.liquidwar6/'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_CONFIG_FILE, _x_ ("Shows the config file path. Default is '$HOME/.liquidwar6/config.xml'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_LOG_FILE, _x_ ("Shows the log file path. Default is '$HOME/.liquidwar6/log.csv'."));
  POPULATE_VOID (sys_context, LW6DEF_SHOW_PREFIX,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_MOD_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_DATA_DIR,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SHOW_SCRIPT_FILE,
		 _x_
   ...
   * Paths
   */
  POPULATE_STR (sys_context, LW6DEF_USER_DIR,
		_x_
		...
		"$HOME/.liquidwar6");
  POPULATE_STR (sys_context, LW6DEF_CONFIG_FILE,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_LOG_FILE,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_PREFIX,
		_x_
		...
		"/usr/local");
  POPULATE_STR (sys_context, LW6DEF_MOD_DIR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_DATA_DIR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MUSIC_DIR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MUSIC_PATH,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MAP_DIR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MAP_PATH,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_SCRIPT_FILE,
		_x_
   ...
   * Players
   */
  POPULATE_STR (sys_context, LW6DEF_PLAYER1_NAME,
		_x_
		("Name of the first player, the player used by default. A default value is provided, you can of course, change it at will."), "<username>");
  POPULATE_STR (sys_context, LW6DEF_PLAYER2_NAME,
		_x_ ("Name of the second player. A default value is provided, you'll certainly want to change it."), "player2-<hostname>");
  POPULATE_STR (sys_context, LW6DEF_PLAYER3_NAME, _x_ ("Name of the third player. A default value is provided, you'll certainly want to change it."),
		"player3-<hostname>");
  POPULATE_STR (sys_context, LW6DEF_PLAYER4_NAME, _x_ ("Name of the fourth player. A default value is provided, you'll certainly want to change it."),
		"player4-<hostname>");
  POPULATE_BOOL (sys_context, LW6DEF_PLAYER1_STATUS, _x_ ("Status of the first player, true if player is activated, false if idle."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_PLAYER2_STATUS, _x_ ("Status of the second player, true if player is activated, false if idle."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_PLAYER3_STATUS, _x_ ("Status of the third player, true if player is activated, false if idle."), 0);
  POPULATE_BOOL (sys_context, LW6DEF_PLAYER4_STATUS, _x_ ("Status of the fourth player, true if player is activated, false if idle."), 0);
  POPULATE_STR (sys_context, LW6DEF_PLAYER1_CONTROL, _x_ ("Control for the first player, must be mouse, keyboard, joystick1, joystick2 or custom."), "mouse");
  POPULATE_STR (sys_context, LW6DEF_PLAYER2_CONTROL, _x_ ("Control for the second player, must be mouse, keyboard, joystick1, joystick2 or custom."),
		"keyboard");
  POPULATE_STR (sys_context, LW6DEF_PLAYER3_CONTROL, _x_ ("Control for the third player, must be mouse, keyboard, joystick1, joystick2 or custom."),
		"joystick1");
  POPULATE_STR (sys_context, LW6DEF_PLAYER4_CONTROL, _x_ ("Control for the fourth player, must be mouse, keyboard, joystick1, joystick2 or custom."),
		"joystick2");
  /*
   * Input
   */
  POPULATE_FLOAT (sys_context, LW6DEF_MOUSE_SENSITIVITY,
		  _x_
		  ...
		  1.0, 0, 0);
  POPULATE_FLOAT (sys_context, LW6DEF_CURSOR_SENSITIVITY,
		  _x_
		  ...
		  1.0, 0, 0);
  POPULATE_FLOAT (sys_context, LW6DEF_MAX_CURSOR_SPEED,
		  _x_
		  ("Maximum cursor speed when cursor is controlled with keyboard or joystick joystick 1. Consider using cursor-sensitivity too."), 10.0, 0, 0);
  POPULATE_INT (sys_context, LW6DEF_REPEAT_DELAY, _x_ ("Time, in milliseconds, before key repeat will start, use 0 to disable."), 500, 0, 0);
  POPULATE_INT (sys_context, LW6DEF_REPEAT_INTERVAL, _x_ ("Time, in milliseconds, between two repeats, once repeat has started, use 0 to disable."), 100, 0,
		0);
  POPULATE_INT (sys_context, LW6DEF_DOUBLE_CLICK_DELAY, _x_ ("Time, in milliseconds, determining wether two consecutive clicks make a double-click or not."),
		333, 0, 0);
  POPULATE_INT (sys_context, LW6DEF_AUTO_RELEASE_DELAY,
		_x_
		...
		250, 0, 0);
  POPULATE_BOOL (sys_context, LW6DEF_USE_DOUBLE_CLICK,
		 _x_
		 ...
		 0);
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_UP, _x_ ("Custom keycode to be used as the UP key equivalent."), "(c-lw6gui-keyboard-is-pressed 101) ; SDLK_e");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_DOWN, _x_ ("Guile custom code associated to the DOWN key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 100) ; SDLK_d");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_LEFT, _x_ ("Guile custom code associated to the LEFT key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 99) ; SDLK_c");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_RIGHT, _x_ ("Guile custom code associated to the RIGHT key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 118) ; SDLK_v");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_ENTER, _x_ ("Guile custom code associated to the ENTER key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 103) ; SDLK_g");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_ESC, _x_ ("Guile custom code associated to the ESC key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 102) ; SDLK_f");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_CTRL, _x_ ("Guile custom code associated to the CTRL key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 98) ; SDLK_b");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_ALT, _x_ ("Guile custom code associated to the ALT key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 110) ; SDLK_n");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_PGUP, _x_ ("Guile custom code associated to the PGUP key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 119) ; SDLK_w");
  POPULATE_STR (sys_context, LW6DEF_CUSTOM_PGDOWN, _x_ ("Guile custom code associated to the PGDOWN key equivalent."),
		"(c-lw6gui-keyboard-is-pressed 115) ; SDLK_s");
  POPULATE_BOOL (sys_context, LW6DEF_CLICK_TO_FOCUS,
		 _x_
		 ...
		 0);
  POPULATE_BOOL (sys_context, LW6DEF_USE_ESC_BUTTON,
		 _x_
		 ...
		 1);
  POPULATE_FLOAT (sys_context, LW6DEF_ZOOM_STEP,
		  _x_ ("A value, strictly greater than 1, which will be used when zooming. The greater it is, the more sensible the zoom is."), 1.1, 0, 0);
  POPULATE_FLOAT (sys_context, LW6DEF_ZOOM_STICK_DELAY, _x_ ("How long, in msec, the zoom will stick to its default value."), 1000, 0, 0);
  /*
   * Graphics
   */
  POPULATE_INT (sys_context, LW6DEF_WIDTH,
		_x_
		...
		-1, 0, 0);;
  POPULATE_INT (sys_context, LW6DEF_HEIGHT,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_GFX_BACKEND,
		...
		"gl1");
  POPULATE_INT (sys_context, LW6DEF_GFX_QUALITY,
		_x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_WINDOWED_MODE_LIMIT,
		  _x_
		  ...
		  0.95, 0, 0);
  POPULATE_BOOL (sys_context, LW6DEF_CAPTURE,
		 _x_ ("Enables capture mode, in which a BMP file is dumped on the disk (in your user directory, search for a 'capture' sub-directory)."), 0);
  /*
   * Sound
   */
  POPULATE_FLOAT (sys_context, LW6DEF_FX_VOLUME, _x_ ("Set the sound effects volume. This is a floating point value. 0 is mute. Maximum value is 1."), 0.3, 0,
		  1);
  POPULATE_FLOAT (sys_context, LW6DEF_WATER_VOLUME, _x_ ("Set the volume for water sounds. This is a floating point value. 0 is mute. Maximum value is 1."),
		  0.2, 0, 1);
  POPULATE_FLOAT (sys_context, LW6DEF_MUSIC_VOLUME, _x_ (" Set the music volume.This is a floating point value. 0 is mute. Maximum value is 1."), 0.6, 0, 1);
  POPULATE_STR (sys_context, LW6DEF_SND_BACKEND,
		_x_ ("Sets the sound backend AKA 'snd' to use. Can be 'ogg' or 'csound' but only 'ogg' will produce sound in the current release."), "ogg");
  POPULATE_STR (sys_context, LW6DEF_AMBIANCE_FILE,
		_x_ ("A music file which will be used to be played during the menus. If not found, game will fallback on random files."), "");
  POPULATE_STR (sys_context, LW6DEF_AMBIANCE_FILTER,
		_x_
		...
		"Chadburn");
  POPULATE_STR (sys_context, LW6DEF_AMBIANCE_EXCLUDE,
  ...
  POPULATE_BOOL (sys_context, LW6DEF_BROADCAST,
		 ...
		 1);
  POPULATE_STR (sys_context, LW6DEF_PASSWORD,
		_x_
		...
		"");
  POPULATE_STR (sys_context, LW6DEF_BIND_IP,
		_x_
		...
		LW6NET_ADDRESS_ANY);
  POPULATE_INT (sys_context, LW6DEF_BIND_PORT,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_CLI_BACKENDS,
		_x_
		...
		"tcp,udp,http");
  POPULATE_STR (sys_context, LW6DEF_SRV_BACKENDS,
		_x_
		...
		"tcpd,udpd,httpd");
  POPULATE_STR (sys_context, LW6DEF_PUBLIC_URL,
		_x_
		...
		"");
  POPULATE_STR (sys_context, LW6DEF_NODE_TITLE,
		_x_
		...
		"");
  POPULATE_STR (sys_context, LW6DEF_NODE_DESCRIPTION,
		_x_
		...
		_x_ ("No description."));
  POPULATE_STR (sys_context, LW6DEF_KNOWN_NODES,
		_x_
   ...
   * Advanced
   */
  POPULATE_VOID (sys_context, LW6DEF_RESET,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_RESET_CONFIG_ON_UPGRADE,
		 _x_ ("If set, then a reset (config file set to defaults) is run every time you upgrade the game."), 1);
  POPULATE_INT (sys_context, LW6DEF_LOG_LEVEL,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TARGET_FPS,
		_x_
		...
		60, 1, 1000);
  POPULATE_INT (sys_context, LW6DEF_IO_PER_SEC,
		_x_
		...
		20, 1, 1000);
  POPULATE_INT (sys_context, LW6DEF_NET_PER_SEC,
		_x_
		...
		500, 1, 1000);
  POPULATE_INT (sys_context, LW6DEF_COMMANDS_PER_SEC,
		_x_
		...
		10, 1, 1000);
  POPULATE_INT (sys_context, LW6DEF_SCREENSHOTS_PER_MIN,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_PILOT_LAG,
		...
		10, 0, 0);
  POPULATE_INT (sys_context, LW6DEF_MEMORY_BAZOOKA_SIZE,
		_x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_MEMORY_BAZOOKA_ERASER,
		 _x_
		 ...
		 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_SPLASH, _x_ ("Set this to 'false' to disable the display of the splash screen at game startup."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_BACKGROUND, _x_ ("Decides wether the background animation/image should be displayed at all."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_PREVIEW, _x_ ("Decides wether a map preview should be displayed when choosing a level."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_MAP, _x_ ("Debugging option which can be set to 'false' to disable map (level) display when playing."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_FIGHTERS, _x_ ("Debugging option which can be set to 'false' to disable the display of fighters when playing."),
		 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_CURSORS, _x_ ("Debugging option which can be set to 'false' to disable the display of cursors when playing."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_HUD, _x_ ("Decides wether the hud (informations while playing) should be displayed."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_SCORE, _x_ ("Decides wether the score screen should be displayed."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_MENU, _x_ ("Debugging option which can be set to 'false' to disable the display of menus."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_META,
		 _x_ ("Set to 'false' to disable the display of meta information, this includes the help, tootips and breadcrumbs in menus."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_PROGRESS,
		 _x_ ("Decides wether a progress bar should be displayed when a long operation is realized as a background task."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_LOG,
  ...
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_FPS,
		 _x_
		 ...
		 0);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_MPS,
		 _x_
		 ...
		 0);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_URL,
		 _x_
		 ...
		 0);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_MOUSE, _x_ ("Set this to 'false' to always hide the mouse pointer."), 1);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_DEBUG_ZONES,
		 _x_ ("Set this to 'true' to display the zones, this is usefull to debug the core algorithm or understand how it works."), 0);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_DEBUG_GRADIENT,
		 _x_ ("Set this to 'true' to display the gradient, this is usefull to debug the core algorithm or understand how it works."), 0);
  POPULATE_BOOL (sys_context, LW6DEF_DISPLAY_CONSOLE,
		 _x_
		 ...
		 0);
  POPULATE_VOID (sys_context, LW6DEF_SERVER,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_DAEMON,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_QUICK_START, _x_ ("Start the game just like if the player had requested a quick start, without showing any menu."));
  POPULATE_VOID (sys_context, LW6DEF_DEMO, _x_ ("Start the game in demo mode. 2 bots play against each other forever."));
  POPULATE_VOID (sys_context, LW6DEF_BENCH,
		 _x_
  ...
  POPULATE_INT (sys_context, LW6DEF_BENCH_VALUE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_LOCAL_BENCH_DELTA,
		_x_
		...
		0, -70, 20);
  POPULATE_INT (sys_context, LW6DEF_NETWORK_BENCH_DELTA,
		_x_
		...
		-5, -70, 20);
  POPULATE_INT (sys_context, LW6DEF_MAX_LOCAL_BENCH_VALUE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_NETWORK_BENCH_VALUE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAGIC_NUMBER,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_BIN_ID,
		_x_
		...
		0, 0, 0);
  POPULATE_VOID (sys_context, LW6DEF_CHECK,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_CUNIT,
		 _x_
  ...
  POPULATE_INT (sys_context, LW6DEF_LOG_TIMEOUT, _x_ ("Delay, in msec, for which a log message will stay displayed on the screen."), 5000, 0, 0);
  POPULATE_FLOAT (sys_context, LW6DEF_GFX_CPU_USAGE,
		  _x_
		  ...
		  0.75, 0, 1);
  POPULATE_INT (sys_context, LW6DEF_DIRTY_READ,
		_x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_GFX_DEBUG,
		 _x_
		 ...
		 0);
  POPULATE_BOOL (sys_context, LW6DEF_EXECUTED_AGAIN,
		 _x_
		 ...
		 0);
  POPULATE_VOID (sys_context, LW6DEF_BASE64_ENCODE,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_BASE64_DECODE,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_Z_ENCODE,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_Z_DECODE,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_NET_LOG,
		 _x_
		 ...
		 0);
  POPULATE_BOOL (sys_context, LW6DEF_OPEN_RELAY,
		 _x_
		 ...
		 0);
  POPULATE_INT (sys_context, LW6DEF_NETWORK_RELIABILITY,
		_x_
		...
		1000, 1, 1000000000);
  POPULATE_BOOL (sys_context, LW6DEF_TROJAN,
		 _x_
		 ...
		 0);
  POPULATE_VOID (sys_context, LW6DEF_SIMULATE_BASIC,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_SIMULATE_FULL,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_TRAP_ERRORS,
		 _x_
  ...
  POPULATE_INT (sys_context, LW6DEF_JPEG_QUALITY,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_DIALOG_TIMEOUT,
		_x_
   ...
   * Game settings
   */
  POPULATE_STR (sys_context, LW6DEF_CHOSEN_MAP,
		_x_
		...
		"subflower");
  POPULATE_BOOL (sys_context, LW6DEF_USE_TEXTURE,
		 _x_
		 ...
		 1);
  POPULATE_BOOL (sys_context, LW6DEF_USE_CURSOR_TEXTURE,
		 _x_
		 ...
		 1);
  POPULATE_BOOL (sys_context, LW6DEF_USE_RULES_XML,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_USE_STYLE_XML,
		 ...
		 1);
  POPULATE_BOOL (sys_context, LW6DEF_USE_TEAMS_XML,
		 _x_
		 ...
		 1);
  POPULATE_BOOL (sys_context, LW6DEF_USE_MUSIC_FILE,
		 _x_
		 ...
		 1);
  POPULATE_STR (sys_context, LW6DEF_FORCE,
		_x_
   ...
   * Map rules
   */
  POPULATE_INT (sys_context, LW6DEF_TOTAL_TIME,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_RESPAWN_TEAM,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_RESPAWN_POSITION_MODE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_RESPAWN_DELAY,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MOVES_PER_ROUND,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_SPREADS_PER_ROUND,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_ROUNDS_PER_SEC,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FIGHTER_ATTACK,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FIGHTER_DEFENSE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FIGHTER_NEW_HEALTH,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FIGHTER_REGENERATE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_SIDE_ATTACK_FACTOR,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_SIDE_DEFENSE_FACTOR,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_NB_MOVE_TRIES,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_NB_ATTACK_TRIES,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_NB_DEFENSE_TRIES,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_VERTICAL_MOVE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_SPREAD_MODE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_SINGLE_ARMY_SIZE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TOTAL_ARMIES_SIZE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_NB_TEAMS,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_NB_CURSORS,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_NB_NODES,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_EXP,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_HIGHEST_TEAM_COLOR_ALLOWED,
		_x_
		...
		LW6MAP_RULES_DEFAULT_HIGHEST_TEAM_COLOR_ALLOWED, LW6MAP_RULES_MIN_HIGHEST_TEAM_COLOR_ALLOWED, LW6MAP_RULES_MAX_HIGHEST_TEAM_COLOR_ALLOWED);
  POPULATE_INT (sys_context, LW6DEF_HIGHEST_WEAPON_ALLOWED,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_X_POLARITY,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_Y_POLARITY,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_Z_POLARITY,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_ZONE_SIZE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_ROUND_DELTA,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_ROUND_DELTA,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_CURSOR_POT,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_CURSOR_POT_INIT,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_CURSOR_POT_OFFSET,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_RED_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_GREEN_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_BLUE_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_YELLOW_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_CYAN_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_MAGENTA_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_ORANGE_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_LIGHTBLUE_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_PURPLE_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_PINK_X,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_RED_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_GREEN_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_BLUE_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_YELLOW_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_CYAN_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_MAGENTA_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_ORANGE_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_LIGHTBLUE_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_PURPLE_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_PINK_Y,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_START_POSITION_MODE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_COLOR_CONFLICT_MODE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_SPREAD_THREAD,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_GLUE_POWER,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_BOOST_POWER,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_DANGER_POWER,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MEDICINE_POWER,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FRAGS_MODE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FRAGS_TO_DISTRIBUTE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_FRAGS_FADE_OUT,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_USE_TEAM_PROFILES,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_RED_AGGRESSIVE, LW6MAP_RULES_MIN_TEAM_PROFILE_RED_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_RED_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_BLUE_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_BLUE_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_CYAN_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_CYAN_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_AGGRESSIVE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PINK_AGGRESSIVE, LW6MAP_RULES_MAX_TEAM_PROFILE_PINK_AGGRESSIVE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_RED_VULNERABLE, LW6MAP_RULES_MIN_TEAM_PROFILE_RED_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_RED_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_BLUE_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_BLUE_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_CYAN_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_CYAN_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_VULNERABLE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PINK_VULNERABLE, LW6MAP_RULES_MAX_TEAM_PROFILE_PINK_VULNERABLE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_MOBILE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_MOBILE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_GREEN_MOBILE, LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_MOBILE, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_MOBILE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_MOBILE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_MOBILE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_YELLOW_MOBILE, LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_MOBILE, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_MOBILE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_MOBILE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_MOBILE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_MAGENTA_MOBILE, LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_MOBILE, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_MOBILE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_MOBILE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_ORANGE_MOBILE, LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_MOBILE, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_MOBILE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_MOBILE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_MOBILE, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_MOBILE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_MOBILE,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_PURPLE_MOBILE, LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_MOBILE, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_MOBILE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_MOBILE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_FAST,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_MAGENTA_FAST, LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_FAST, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_FAST);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_FAST,
		_x_
		...
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_LIGHTBLUE_FAST, LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_FAST, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_FAST);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_FAST,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_HANDICAP,
		_x_
		("Defines the handicap for the red team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_RED_HANDICAP, LW6MAP_RULES_MIN_TEAM_PROFILE_RED_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_RED_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_HANDICAP,
		_x_
		("Defines the handicap for the green team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_GREEN_HANDICAP, LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_HANDICAP,
		_x_
		("Defines the handicap for the blue team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_BLUE_HANDICAP, LW6MAP_RULES_MIN_TEAM_PROFILE_BLUE_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_BLUE_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_HANDICAP,
		_x_
		("Defines the handicap for the yellow team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_YELLOW_HANDICAP,
		LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_HANDICAP,
		_x_
		("Defines the handicap for the cyan team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_CYAN_HANDICAP, LW6MAP_RULES_MIN_TEAM_PROFILE_CYAN_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_CYAN_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_HANDICAP,
		_x_
		("Defines the handicap for the magenta team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_MAGENTA_HANDICAP,
		LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_HANDICAP,
		_x_
		("Defines the handicap for the orange team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_ORANGE_HANDICAP,
		LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_HANDICAP,
		_x_
		("Defines the handicap for the lightblue team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_LIGHTBLUE_HANDICAP,
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_HANDICAP,
		_x_
		("Defines the handicap for the purple team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_PURPLE_HANDICAP,
		LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_HANDICAP,
		_x_
		("Defines the handicap for the pink team."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_PINK_HANDICAP, LW6MAP_RULES_MIN_TEAM_PROFILE_PINK_HANDICAP, LW6MAP_RULES_MAX_TEAM_PROFILE_PINK_HANDICAP);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_WEAPON_ID,
		_x_
		("Id of the default weapon for the red team, see the documentation about weapons to know what these ids mean."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_RED_WEAPON_ID, LW6MAP_RULES_MIN_TEAM_PROFILE_RED_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_RED_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_WEAPON_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_WEAPON_ID,
		_x_
		("Id of the default weapon for the blue team, see the documentation about weapons to know what these ids mean."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_BLUE_WEAPON_ID, LW6MAP_RULES_MIN_TEAM_PROFILE_BLUE_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_BLUE_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_WEAPON_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_WEAPON_ID,
		_x_
		("Id of the default weapon for the cyan team, see the documentation about weapons to know what these ids mean."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_CYAN_WEAPON_ID, LW6MAP_RULES_MIN_TEAM_PROFILE_CYAN_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_CYAN_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_WEAPON_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_WEAPON_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_WEAPON_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_WEAPON_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_WEAPON_ID,
		_x_
		("Id of the default weapon for the pink team, see the documentation about weapons to know what these ids mean."),
		LW6MAP_RULES_DEFAULT_TEAM_PROFILE_PINK_WEAPON_ID, LW6MAP_RULES_MIN_TEAM_PROFILE_PINK_WEAPON_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_PINK_WEAPON_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_RED_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_RED_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_BLUE_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_BLUE_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_CYAN_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_CYAN_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_WEAPON_ALTERNATE_ID,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PINK_WEAPON_ALTERNATE_ID, LW6MAP_RULES_MAX_TEAM_PROFILE_PINK_WEAPON_ALTERNATE_ID);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_RED_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_RED_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_RED_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_GREEN_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_GREEN_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_GREEN_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_BLUE_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_BLUE_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_BLUE_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_YELLOW_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_YELLOW_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_YELLOW_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_CYAN_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_CYAN_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_CYAN_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_MAGENTA_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_MAGENTA_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_MAGENTA_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_ORANGE_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_ORANGE_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_ORANGE_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_LIGHTBLUE_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_LIGHTBLUE_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_LIGHTBLUE_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PURPLE_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PURPLE_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_PURPLE_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_TEAM_PROFILE_PINK_WEAPON_MODE,
		_x_
		...
		LW6MAP_RULES_MIN_TEAM_PROFILE_PINK_WEAPON_MODE, LW6MAP_RULES_MAX_TEAM_PROFILE_PINK_WEAPON_MODE);
  POPULATE_INT (sys_context, LW6DEF_WEAPON_DURATION,
		_x_
		("How long all weapons (for which duration makes sense) will last. Unit is seconds."),
		LW6MAP_RULES_DEFAULT_WEAPON_DURATION, LW6MAP_RULES_MIN_WEAPON_DURATION, LW6MAP_RULES_MAX_WEAPON_DURATION);
  POPULATE_INT (sys_context, LW6DEF_WEAPON_CHARGE_DELAY,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_WEAPON_CHARGE_MAX,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_WEAPON_TUNE_BERZERK_POWER,
		_x_
		("Use to specifiy how strong berzerk mode is, if set to 3, then attacks will be 3 times as efficient in berzerk mode."),
		LW6MAP_RULES_DEFAULT_WEAPON_TUNE_BERZERK_POWER, LW6MAP_RULES_MIN_WEAPON_TUNE_BERZERK_POWER, LW6MAP_RULES_MAX_WEAPON_TUNE_BERZERK_POWER);
  POPULATE_INT (sys_context, LW6DEF_WEAPON_TUNE_TURBO_POWER,
		_x_
   ...
   * map hints
   */
  POPULATE_BOOL (sys_context, LW6DEF_RESAMPLE,
		 _x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MIN_MAP_WIDTH,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_MAP_WIDTH,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MIN_MAP_HEIGHT,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_MAP_HEIGHT,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MIN_MAP_SURFACE,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_MAX_MAP_SURFACE,
		_x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_FIGHTER_SCALE,
		  _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_DOWNSIZE_USING_FIGHTER_SCALE,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_UPSIZE_USING_FIGHTER_SCALE,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_DOWNSIZE_USING_BENCH_VALUE,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_UPSIZE_USING_BENCH_VALUE,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_GUESS_COLORS,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_BACKGROUND_COLOR_AUTO,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_HUD_COLOR_AUTO,
		 _x_
		 ("Defines wether hud colors will be set automatically from base and alternate colors. This is a time saver to keep map designers from requiring to redefined every single color in the game. You only need to set color-base-bg, color-base-fg, color-alternate-bg and color-alternate-fg. Then hud_color_frame_bg, hud_color_frame_fg, hud_color_text_bg and hud_color_text_fg will be automatically set."),
		 LW6LDR_HINTS_DEFAULT_HUD_COLOR_AUTO);
  POPULATE_BOOL (sys_context, LW6DEF_MENU_COLOR_AUTO,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_VIEW_COLOR_AUTO,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_SYSTEM_COLOR_AUTO,
		 _x_
  ...
  POPULATE_INT (sys_context, LW6DEF_WALL_GREASE,
		_x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_GUESS_MOVES_PER_SEC,
		 _x_ ("If set, then loader will use 'time-to-cross-level' to guess the game speed parameters."), LW6LDR_HINTS_DEFAULT_GUESS_MOVES_PER_SEC);
  POPULATE_FLOAT (sys_context, LW6DEF_SPEED,
		  _x_
   ...
   * Map style
   */
  POPULATE_BOOL (sys_context, LW6DEF_KEEP_RATIO,
		 _x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_ZOOM,
		  _x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_ZOOM_MIN,
		  _x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_ZOOM_MAX,
		  _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_X_WRAP,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_Y_WRAP,
		 _x_
  ...
  POPULATE_STR (sys_context, LW6DEF_BACKGROUND_STYLE,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_HUD_STYLE,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MENU_STYLE,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_VIEW_STYLE,
		_x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_ANIMATION_DENSITY,
		  _x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_ANIMATION_SPEED,
		  _x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_CURSOR_SIZE,
		  _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_COLORIZE_CURSOR,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_BLINK_CURSOR,
		 _x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_HIDDEN_LAYER_ALPHA,
		  _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_COLORIZE,
		 _x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_PIXELIZE,
		 _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_COLOR_BASE_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_COLOR_BASE_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_COLOR_ALTERNATE_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_COLOR_ALTERNATE_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_BACKGROUND_COLOR_ROOT_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_BACKGROUND_COLOR_ROOT_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_BACKGROUND_COLOR_STUFF_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_BACKGROUND_COLOR_STUFF_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_HUD_COLOR_FRAME_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_HUD_COLOR_FRAME_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_HUD_COLOR_TEXT_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_HUD_COLOR_TEXT_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_MENU_COLOR_DEFAULT_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_MENU_COLOR_DEFAULT_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_MENU_COLOR_SELECTED_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_MENU_COLOR_SELECTED_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_MENU_COLOR_DISABLED_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_MENU_COLOR_DISABLED_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_VIEW_COLOR_CURSOR_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_VIEW_COLOR_CURSOR_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_VIEW_COLOR_MAP_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_VIEW_COLOR_MAP_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_SYSTEM_COLOR_BG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_SYSTEM_COLOR_FG,
		  _x_
  ...
  POPULATE_COLOR (sys_context, LW6DEF_TEAM_COLOR_DEAD,
		  _x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MUSIC_FILTER,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_MUSIC_EXCLUDE,
		_x_
  ...
  POPULATE_BOOL (sys_context, LW6DEF_WAVES, _x_ ("Activates the wave effect, that's to say level appears to be under water when playing."),
		 LW6MAP_STYLE_DEFAULT_WAVES);
  /*
   * Map teams
   */
  POPULATE_STR (sys_context, LW6DEF_PLAYER1_COLOR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_PLAYER2_COLOR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_PLAYER3_COLOR,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_PLAYER4_COLOR,
		_x_
  ...
  POPULATE_INT (sys_context, LW6DEF_NB_BOTS,
		_x_
  ...
  POPULATE_FLOAT (sys_context, LW6DEF_BOT_SPEED,
		  _x_
  ...
  POPULATE_INT (sys_context, LW6DEF_BOT_IQ,
		_x_
  ...
  POPULATE_STR (sys_context, LW6DEF_BOT1_COLOR, _x_ ("Color for bot number 1."), LW6MAP_TEAMS_DEFAULT_BOT1_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT2_COLOR, _x_ ("Color for bot number 2."), LW6MAP_TEAMS_DEFAULT_BOT2_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT3_COLOR, _x_ ("Color for bot number 3."), LW6MAP_TEAMS_DEFAULT_BOT3_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT4_COLOR, _x_ ("Color for bot number 4."), LW6MAP_TEAMS_DEFAULT_BOT4_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT5_COLOR, _x_ ("Color for bot number 5."), LW6MAP_TEAMS_DEFAULT_BOT5_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT6_COLOR, _x_ ("Color for bot number 6."), LW6MAP_TEAMS_DEFAULT_BOT6_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT7_COLOR, _x_ ("Color for bot number 7."), LW6MAP_TEAMS_DEFAULT_BOT7_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT8_COLOR, _x_ ("Color for bot number 8."), LW6MAP_TEAMS_DEFAULT_BOT8_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT9_COLOR, _x_ ("Color for bot number 9."), LW6MAP_TEAMS_DEFAULT_BOT9_COLOR);
  POPULATE_STR (sys_context, LW6DEF_BOT1_AI, _x_ ("AI engine for bot number 1."), LW6MAP_TEAMS_DEFAULT_BOT1_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT2_AI, _x_ ("AI engine for bot number 2."), LW6MAP_TEAMS_DEFAULT_BOT2_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT3_AI, _x_ ("AI engine for bot number 3."), LW6MAP_TEAMS_DEFAULT_BOT3_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT4_AI, _x_ ("AI engine for bot number 4."), LW6MAP_TEAMS_DEFAULT_BOT4_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT5_AI, _x_ ("AI engine for bot number 5."), LW6MAP_TEAMS_DEFAULT_BOT5_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT6_AI, _x_ ("AI engine for bot number 6."), LW6MAP_TEAMS_DEFAULT_BOT6_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT7_AI, _x_ ("AI engine for bot number 7."), LW6MAP_TEAMS_DEFAULT_BOT7_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT8_AI, _x_ ("AI engine for bot number 8."), LW6MAP_TEAMS_DEFAULT_BOT8_AI);
  POPULATE_STR (sys_context, LW6DEF_BOT9_AI, _x_ ("AI engine for bot number 9."), LW6MAP_TEAMS_DEFAULT_BOT9_AI);
  /*
   * Funcs
   */
  POPULATE_VOID (sys_context, LW6DEF_C_GETTEXT,
		 _x_
  ...
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SET_MEMORY_BAZOOKA_SIZE, _x_ ("Wrapper on lw6sys_set_memory_bazooka_size."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MEMORY_BAZOOKA_SIZE, _x_ ("Wrapper on lw6sys_get_memory_bazooka_size."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SET_MEMORY_BAZOOKA_ERASER, _x_ ("Wrapper on lw6sys_set_memory_bazooka_eraser."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MEMORY_BAZOOKA_ERASER, _x_ ("Wrapper on lw6sys_get_memory_bazooka_eraser."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_TARNAME, _x_ ("Wrapper on lw6sys_build_get_package_tarname."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_NAME, _x_ ("Wrapper on lw6sys_build_get_package_name."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_STRING, _x_ ("Wrapper on lw6sys_build_get_package_string."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_ID, _x_ ("Wrapper on lw6sys_build_get_package_id."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_VERSION, _x_ ("Wrapper on lw6sys_build_get_version."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_CODENAME, _x_ ("Wrapper on lw6sys_build_get_codename."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_VERSION_BASE, _x_ ("Wrapper on lw6sys_build_get_version_base."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_VERSION_MAJOR, _x_ ("Wrapper on lw6sys_build_get_version_major."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_VERSION_MINOR, _x_ ("Wrapper on lw6sys_build_get_version_minor."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_STAMP, _x_ ("Wrapper on lw6sys_build_get_stamp."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_MD5SUM, _x_ ("Wrapper on lw6sys_build_get_md5sum."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_COPYRIGHT, _x_ ("Wrapper on lw6sys_build_get_copyright."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_LICENSE, _x_ ("Wrapper on lw6sys_build_get_license."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_HOME_URL, _x_ ("Wrapper on lw6sys_build_get_home_url."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_BUGS_URL, _x_ ("Wrapper on lw6sys_build_get_bugs_url."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_CONFIGURE_ARGS, _x_ ("Wrapper on lw6sys_build_get_configure_args."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_GCC_VERSION, _x_ ("Wrapper on lw6sys_build_get_gcc_version."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_CFLAGS, _x_ ("Wrapper on lw6sys_build_get_cflags."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_LDFLAGS, _x_ ("Wrapper on lw6sys_build_get_ldflags."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_HOSTNAME, _x_ ("Wrapper on lw6sys_build_get_hostname."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_DATE, _x_ ("Wrapper on lw6sys_build_get_date."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_TIME, _x_ ("Wrapper on lw6sys_build_get_time."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_HOST_CPU, _x_ ("Wrapper on lw6sys_build_get_host_cpu."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENDIANNESS, _x_ ("Wrapper on lw6sys_build_get_endianness."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_POINTER_SIZE, _x_ ("Wrapper on lw6sys_build_get_pointer_size."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_IS_X86, _x_ ("Wrapper on lw6sys_build_is_x86."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_HOST_OS, _x_ ("Wrapper on lw6sys_build_get_host_os."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_IS_GNU, _x_ ("Wrapper on lw6sys_build_is_gnu."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_IS_UNIX, _x_ ("Wrapper on lw6sys_build_is_unix."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_IS_MS_WINDOWS, _x_ ("Wrapper on lw6sys_build_is_ms_windows."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_IS_MAC_OS_X, _x_ ("Wrapper on lw6sys_build_is_mac_os_x."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_IS_GP2X, _x_ ("Wrapper on lw6sys_build_is_gp2x."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_TOP_SRCDIR, _x_ ("Wrapper on lw6sys_build_get_top_srcdir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ABS_SRCDIR, _x_ ("Wrapper on lw6sys_build_get_abs_srcdir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_PREFIX, _x_ ("Wrapper on lw6sys_build_get_prefix."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_DATADIR, _x_ ("Wrapper on lw6sys_build_get_datadir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_LIBDIR, _x_ ("Wrapper on lw6sys_build_get_libdir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_INCLUDEDIR, _x_ ("Wrapper on lw6sys_build_get_includedir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_LOCALEDIR, _x_ ("Wrapper on lw6sys_build_get_localedir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_DOCDIR, _x_ ("Wrapper on lw6sys_build_get_docdir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_CONSOLE, _x_ ("Wrapper on lw6sys_build_get_enable_console."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_GTK, _x_ ("Wrapper on lw6sys_build_get_enable_gtk."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_GL1, _x_ ("Wrapper on lw6sys_build_get_enable_mod_gl1."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_GLES2, _x_ ("Wrapper on lw6sys_build_get_enable_mod_gles2."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_SOFT, _x_ ("Wrapper on lw6sys_build_get_enable_mod_soft."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_CACA, _x_ ("Wrapper on lw6sys_build_get_enable_mod_caca."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_CSOUND, _x_ ("Wrapper on lw6sys_build_get_enable_mod_csound."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_OGG, _x_ ("Wrapper on lw6sys_build_get_enable_mod_ogg."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_HTTP, _x_ ("Wrapper on lw6sys_build_get_enable_mod_http."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_OPENMP, _x_ ("Wrapper on lw6sys_build_get_enable_openmp."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_OPTIMIZE, _x_ ("Wrapper on lw6sys_build_get_enable_optimize."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_ALLINONE, _x_ ("Wrapper on lw6sys_build_get_enable_allinone."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_FULLSTATIC, _x_ ("Wrapper on lw6sys_build_get_enable_fullstatic."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_PARANOID, _x_ ("Wrapper on lw6sys_build_get_enable_paranoid."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_GPROF, _x_ ("Wrapper on lw6sys_build_get_enable_gprof."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_INSTRUMENT, _x_ ("Wrapper on lw6sys_build_get_enable_instrument."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_PROFILER, _x_ ("Wrapper on lw6sys_build_get_enable_profiler."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_GCOV, _x_ ("Wrapper on lw6sys_build_get_enable_gcov."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_VALGRIND, _x_ ("Wrapper on lw6sys_build_get_enable_valgrind."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_BUILD_GET_BIN_ID, _x_ ("Wrapper on lw6sys_build_get_bin_id."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_DEBUG_GET, _x_ ("Wrapper on lw6sys_debug_get."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_DEBUG_SET, _x_ ("Wrapper on lw6sys_debug_set."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_DUMP, _x_ ("Wrapper on lw6sys_dump."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_DUMP_CLEAR, _x_ ("Wrapper on lw6sys_dump_clear."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_USERNAME, _x_ ("Wrapper on lw6sys_get_username."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_HOSTNAME, _x_ ("Wrapper on lw6sys_get_hostname."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GETENV, _x_ ("Wrapper on lw6sys_getenv."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GETENV_PREFIXED, _x_ ("Wrapper on lw6sys_getenv_prefixed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GENERATE_ID_16, _x_ ("Wrapper on lw6sys_generate_id_16."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GENERATE_ID_32, _x_ ("Wrapper on lw6sys_generate_id_32."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GENERATE_ID_64, _x_ ("Wrapper on lw6sys_generate_id_64."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_LOG, _x_ ("Wrapper on lw6sys_log."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_LOG_SET_DIALOG_TIMEOUT, _x_ ("Wrapper on lw6sys_log_set_dialog_timeout."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_LOG_GET_LEVEL, _x_ ("Wrapper on lw6sys_log_get_level."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_LOG_SET_LEVEL, _x_ ("Wrapper on lw6sys_log_set_level."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_LOG_GET_BACKTRACE_MODE, _x_ ("Wrapper on lw6sys_log_get_backtrace_mode."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_LOG_SET_BACKTRACE_MODE, _x_ ("Wrapper on lw6sys_log_set_backtrace_mode."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_MEGABYTES_AVAILABLE, _x_ ("Wrapper on lw6sys_megabytes_available."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_OPENMP_GET_NUM_PROCS, _x_ ("Wrapper on lw6sys_openmp_get_num_procs."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_USER_DIR, _x_ ("Wrapper on lw6sys_get_default_user_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_CONFIG_FILE, _x_ ("Wrapper on lw6sys_get_default_config_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_LOG_FILE, _x_ ("Wrapper on lw6sys_get_default_log_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_PREFIX, _x_ ("Wrapper on lw6sys_get_default_prefix."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_MOD_DIR, _x_ ("Wrapper on lw6sys_get_default_mod_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_DATA_DIR, _x_ ("Wrapper on lw6sys_get_default_data_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_MUSIC_DIR, _x_ ("Wrapper on lw6sys_get_default_music_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_MUSIC_PATH, _x_ ("Wrapper on lw6sys_get_default_music_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_MAP_DIR, _x_ ("Wrapper on lw6sys_get_default_map_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_MAP_PATH, _x_ ("Wrapper on lw6sys_get_default_map_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DEFAULT_SCRIPT_FILE, _x_ ("Wrapper on lw6sys_get_default_script_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_CWD, _x_ ("Wrapper on lw6sys_get_cwd."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_RUN_DIR, _x_ ("Wrapper on lw6sys_get_run_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_USER_DIR, _x_ ("Wrapper on lw6sys_get_user_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_CONFIG_FILE, _x_ ("Wrapper on lw6sys_get_config_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_LOG_FILE, _x_ ("Wrapper on lw6sys_get_log_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_PREFIX, _x_ ("Wrapper on lw6sys_get_prefix."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MOD_DIR, _x_ ("Wrapper on lw6sys_get_mod_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_DATA_DIR, _x_ ("Wrapper on lw6sys_get_data_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MUSIC_DIR, _x_ ("Wrapper on lw6sys_get_music_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MUSIC_PATH, _x_ ("Wrapper on lw6sys_get_music_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MAP_DIR, _x_ ("Wrapper on lw6sys_get_map_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_MAP_PATH, _x_ ("Wrapper on lw6sys_get_map_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_SCRIPT_FILE, _x_ ("Wrapper on lw6sys_get_script_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_PATH_CONCAT, _x_ ("Wrapper on lw6sys_path_concat."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_PATH_FILE_ONLY, _x_ ("Wrapper on lw6sys_path_file_only."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_PATH_PARENT, _x_ ("Wrapper on lw6sys_path_parent."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_PATH_SPLIT, _x_ ("Wrapper on lw6sys_path_split."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SIGNAL_CUSTOM, _x_ ("Wrapper on lw6sys_signal_custom."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SIGNAL_DEFAULT, _x_ ("Wrapper on lw6sys_signal_default."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SIGNAL_SEND_QUIT, _x_ ("Wrapper on lw6sys_signal_send_quit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SIGNAL_POLL_QUIT, _x_ ("Wrapper on lw6sys_signal_poll_quit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_TIMESTAMP, _x_ ("Wrapper on lw6sys_get_timestamp."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_UPTIME, _x_ ("Wrapper on lw6sys_get_uptime."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_GET_CYCLE, _x_ ("Wrapper on lw6sys_get_cycle."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SLEEP, _x_ ("Wrapper on lw6sys_sleep."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_DELAY, _x_ ("Wrapper on lw6sys_delay."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_IDLE, _x_ ("Wrapper on lw6sys_idle."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_SNOOZE, _x_ ("Wrapper on lw6sys_snooze."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SYS_URL_CANONIZE, _x_ ("Wrapper on lw6sys_url_canonize."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_ABOUT, _x_ ("Wrapper on lw6hlp_about."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_GET_DEFAULT_VALUE, _x_ ("Wrapper on lw6hlp_get_default_value."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_QUICK, _x_ ("Wrapper on lw6hlp_list_quick."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_DOC, _x_ ("Wrapper on lw6hlp_list_doc."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_SHOW, _x_ ("Wrapper on lw6hlp_list_show."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_PATH, _x_ ("Wrapper on lw6hlp_list_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_PLAYERS, _x_ ("Wrapper on lw6hlp_list_players."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_INPUT, _x_ ("Wrapper on lw6hlp_list_input."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_GRAPHICS, _x_ ("Wrapper on lw6hlp_list_graphics."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_SOUND, _x_ ("Wrapper on lw6hlp_list_sound."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_NETWORK, _x_ ("Wrapper on lw6hlp_list_network."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_MAP, _x_ ("Wrapper on lw6hlp_list_map."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_MAP_RULES, _x_ ("Wrapper on lw6hlp_list_map_rules."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_MAP_HINTS, _x_ ("Wrapper on lw6hlp_list_map_hints."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_MAP_STYLE, _x_ ("Wrapper on lw6hlp_list_map_style."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_MAP_TEAMS, _x_ ("Wrapper on lw6hlp_list_map_teams."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_FUNCS, _x_ ("Wrapper on lw6hlp_list_funcs."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_HOOKS, _x_ ("Wrapper on lw6hlp_list_hooks."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_ADVANCED, _x_ ("Wrapper on lw6hlp_list_advanced."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_ALIASES, _x_ ("Wrapper on lw6hlp_list_aliases."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_TEAM_COLORS, _x_ ("Wrapper on lw6hlp_list_team_colors."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST_WEAPONS, _x_ ("Wrapper on lw6hlp_list_weapons."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6HLP_LIST, _x_ ("Wrapper on lw6hlp_list."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_DEFAULTS, _x_ ("Wrapper on lw6cfg_defaults."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_LOAD, _x_ ("Wrapper on lw6cfg_load."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_OPTION_EXISTS, _x_ ("Wrapper on lw6cfg_option_exists."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_GET_OPTION, _x_ ("Wrapper on lw6cfg_get_option."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_SET_OPTION, _x_ ("Wrapper on lw6cfg_set_option."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_SAVE, _x_ ("Wrapper on lw6cfg_save."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_INIT, _x_ ("Wrapper on lw6cfg_init."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_QUIT, _x_ ("Wrapper on lw6cfg_quit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_UNIFIED_GET_USER_DIR, _x_ ("Wrapper on lw6cfg_unified_get_user_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_UNIFIED_GET_LOG_FILE, _x_ ("Wrapper on lw6cfg_unified_get_log_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_UNIFIED_GET_MUSIC_PATH, _x_ ("Wrapper on lw6cfg_unified_get_music_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CFG_UNIFIED_GET_MAP_PATH, _x_ ("Wrapper on lw6cfg_unified_get_map_path."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_NEW, _x_ ("Wrapper on lw6gui_menu_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_APPEND, _x_ ("Wrapper on lw6gui_menu_append."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_REMOVE, _x_ ("Wrapper on lw6gui_menu_remove."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_REMOVE_ALL, _x_ ("Wrapper on lw6gui_menu_remove_all."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_SYNC, _x_ ("Wrapper on lw6gui_menu_sync."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_SELECT, _x_ ("Wrapper on lw6gui_menu_select."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_SELECT_ESC, _x_ ("Wrapper on lw6gui_menu_select_esc."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_ENABLE_ESC, _x_ ("Wrapper on lw6gui_menu_enable_esc."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_SCROLL_UP, _x_ ("Wrapper on lw6gui_menu_scroll_up."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_SCROLL_DOWN, _x_ ("Wrapper on lw6gui_menu_scroll_down."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_SET_BREADCRUMBS, _x_ ("Wrapper on lw6gui_menu_set_breadcrumbs."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_CLOSE_POPUP, _x_ ("Wrapper on lw6gui_menu_close_popup."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MENU_HAS_POPUP, _x_ ("Wrapper on lw6gui_menu_has_popup."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_DEFAULT_LOOK, _x_ ("Wrapper on lw6gui_default_look."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_LOOK_SET, _x_ ("Wrapper on lw6gui_look_set."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_LOOK_GET, _x_ ("Wrapper on lw6gui_look_get."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_LOOK_ZOOM_IN, _x_ ("Wrapper on lw6gui_look_zoom_in."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_LOOK_ZOOM_OUT, _x_ ("Wrapper on lw6gui_look_zoom_out."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_INPUT_RESET, _x_ ("Wrapper on lw6gui_input_reset."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POLL_MOVE, _x_ ("Wrapper on lw6gui_mouse_poll_move."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_GET_STATE, _x_ ("Wrapper on lw6gui_mouse_get_state."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_IS_PRESSED, _x_ ("Wrapper on lw6gui_keyboard_is_pressed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_GET_MOVE_PAD, _x_ ("Wrapper on lw6gui_keyboard_get_move_pad."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_GET_MOVE_PAD, _x_ ("Wrapper on lw6gui_joystick1_get_move_pad."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_GET_MOVE_PAD, _x_ ("Wrapper on lw6gui_joystick2_get_move_pad."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_BUTTON_LEFT, _x_ ("Wrapper on lw6gui_mouse_pop_button_left."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_BUTTON_RIGHT, _x_ ("Wrapper on lw6gui_mouse_pop_button_right."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_BUTTON_MIDDLE, _x_ ("Wrapper on lw6gui_mouse_pop_button_middle."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_SIMPLE_CLICK, _x_ ("Wrapper on lw6gui_mouse_pop_simple_click."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_DOUBLE_CLICK, _x_ ("Wrapper on lw6gui_mouse_pop_double_click."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_TRIPLE_CLICK, _x_ ("Wrapper on lw6gui_mouse_pop_triple_click."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_WHEEL_UP, _x_ ("Wrapper on lw6gui_mouse_pop_wheel_up."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_MOUSE_POP_WHEEL_DOWN, _x_ ("Wrapper on lw6gui_mouse_pop_wheel_down."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_UP, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_up."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_DOWN, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_down."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_LEFT, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_left."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_RIGHT, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_right."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_ENTER, _x_ ("Wrapper on lw6gui_keyboard_pop_key_enter."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_ESC, _x_ ("Wrapper on lw6gui_keyboard_pop_key_esc."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_CTRL, _x_ ("Wrapper on lw6gui_keyboard_pop_key_ctrl."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_ALT, _x_ ("Wrapper on lw6gui_keyboard_pop_key_alt."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_PGUP, _x_ ("Wrapper on lw6gui_keyboard_pop_key_pgup."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_PGDOWN, _x_ ("Wrapper on lw6gui_keyboard_pop_key_pgdown."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_UP, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_up."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_DOWN, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_down."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_LEFT, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_left."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_RIGHT, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_right."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_A, _x_ ("Wrapper on lw6gui_joystick1_pop_button_a."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_B, _x_ ("Wrapper on lw6gui_joystick1_pop_button_b."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_C, _x_ ("Wrapper on lw6gui_joystick1_pop_button_c."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_D, _x_ ("Wrapper on lw6gui_joystick1_pop_button_d."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_E, _x_ ("Wrapper on lw6gui_joystick1_pop_button_e."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_F, _x_ ("Wrapper on lw6gui_joystick1_pop_button_f."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_UP, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_up."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_DOWN, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_down."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_LEFT, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_left."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_RIGHT, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_right."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_A, _x_ ("Wrapper on lw6gui_joystick2_pop_button_a."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_B, _x_ ("Wrapper on lw6gui_joystick2_pop_button_b."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_C, _x_ ("Wrapper on lw6gui_joystick2_pop_button_c."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_D, _x_ ("Wrapper on lw6gui_joystick2_pop_button_d."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_E, _x_ ("Wrapper on lw6gui_joystick2_pop_button_e."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_F, _x_ ("Wrapper on lw6gui_joystick2_pop_button_f."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GFX_GET_BACKENDS, _x_ ("Wrapper on lw6gfx_get_backends."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_NEW, _x_ ("Wrapper on lw6dsp_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_RELEASE, _x_ ("Wrapper on lw6dsp_release."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_UPDATE, _x_ ("Wrapper on lw6dsp_update."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_GET_NB_FRAMES, _x_ ("Wrapper on lw6dsp_get_nb_frames."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_GET_LAST_FRAME_RENDERING_TIME, _x_ ("Wrapper on lw6dsp_get_last_frame_rendering_time."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_GET_INSTANT_FPS, _x_ ("Wrapper on lw6dsp_get_instant_fps."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_GET_AVERAGE_FPS, _x_ ("Wrapper on lw6dsp_get_average_fps."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_GET_VIDEO_MODE, _x_ ("Wrapper on lw6dsp_get_video_mode."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6DSP_GET_FULLSCREEN_MODES, _x_ ("Wrapper on lw6dsp_get_fullscreen_modes."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_GET_ENTRIES, _x_ ("Wrapper on lw6ldr_get_entries."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_READ, _x_ ("Wrapper on lw6ldr_read."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_READ_RELATIVE, _x_ ("Wrapper on lw6ldr_read_relative."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_PRINT_EXAMPLES, _x_ ("Wrapper on lw6ldr_print_examples."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_HINTS_GET_DEFAULT, _x_ ("Wrapper on lw6ldr_hints_get_default."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_EXP_VALIDATE, _x_ ("Wrapper on lw6ldr_exp_validate."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6LDR_CHAIN_ENTRY, _x_ ("Wrapper on lw6ldr_chain_entry."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_GET_LOOK, _x_ ("Wrapper on lw6map_get_look."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_PARAM_GET, _x_ ("Wrapper on lw6map_param_get."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_GET_TITLE, _x_ ("Wrapper on lw6map_get_title."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_GET_MUSIC_DIR, _x_ ("Wrapper on lw6map_get_music_dir."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_TEAM_COLOR_INDEX_TO_KEY, _x_ ("Wrapper on lw6map_team_color_index_to_key."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_TEAM_COLOR_KEY_TO_INDEX, _x_ ("Wrapper on lw6map_team_color_key_to_index."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_TEAM_COLOR_INDEX_TO_LABEL, _x_ ("Wrapper on lw6map_team_color_index_to_label."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_TEAM_COLOR_LIST, _x_ ("Wrapper on lw6map_team_color_list."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_WEAPON_INDEX_TO_KEY, _x_ ("Wrapper on lw6map_weapon_index_to_key."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_WEAPON_KEY_TO_INDEX, _x_ ("Wrapper on lw6map_weapon_key_to_index."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_WEAPON_INDEX_TO_LABEL, _x_ ("Wrapper on lw6map_weapon_index_to_label."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_WEAPON_LIST, _x_ ("Wrapper on lw6map_weapon_list."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_RULES_GET_DEFAULT, _x_ ("Wrapper on lw6map_rules_get_default."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_RULES_GET_MIN, _x_ ("Wrapper on lw6map_rules_get_min."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_RULES_GET_MAX, _x_ ("Wrapper on lw6map_rules_get_max."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_RULES_GET_INT, _x_ ("Wrapper on lw6map_rules_get_int."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_STYLE_GET_DEFAULT, _x_ ("Wrapper on lw6map_style_get_default."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_TEAMS_GET_DEFAULT, _x_ ("Wrapper on lw6map_teams_get_default."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_EXP_IS_TEAM_COLOR_ALLOWED, _x_ ("Wrapper on lw6map_exp_is_team_color_allowed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_EXP_IS_WEAPON_ALLOWED, _x_ ("Wrapper on lw6map_exp_is_weapon_allowed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_EXP_GET_UNLOCKED_TEAM_COLOR, _x_ ("Wrapper on lw6map_exp_get_unlocked_team_color."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_EXP_GET_UNLOCKED_WEAPON, _x_ ("Wrapper on lw6map_exp_get_unlocked_weapon."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_GET_MAX_NB_COLORS, _x_ ("Wrapper on lw6map_get_max_nb_colors."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_GET_MAX_NB_CURSORS, _x_ ("Wrapper on lw6map_get_max_nb_cursors."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6MAP_GET_MAX_NB_NODES, _x_ ("Wrapper on lw6map_get_max_nb_nodes."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_BUILD_GAME_STRUCT, _x_ ("Wrapper on lw6ker_build_game_struct."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_BUILD_GAME_STATE, _x_ ("Wrapper on lw6ker_build_game_state."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_SYNC_GAME_STATE, _x_ ("Wrapper on lw6ker_sync_game_state."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_DUP_GAME_STATE, _x_ ("Wrapper on lw6ker_dup_game_state."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GAME_STRUCT_CHECKSUM, _x_ ("Wrapper on lw6ker_game_struct_checksum."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GAME_STATE_CHECKSUM, _x_ ("Wrapper on lw6ker_game_state_checksum."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_REGISTER_NODE, _x_ ("Wrapper on lw6ker_register_node."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_UNREGISTER_NODE, _x_ ("Wrapper on lw6ker_unregister_node."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_NODE_EXISTS, _x_ ("Wrapper on lw6ker_node_exists."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_ADD_CURSOR, _x_ ("Wrapper on lw6ker_add_cursor."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_REMOVE_CURSOR, _x_ ("Wrapper on lw6ker_remove_cursor."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_CURSOR_EXISTS, _x_ ("Wrapper on lw6ker_cursor_exists."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_CURSOR, _x_ ("Wrapper on lw6ker_get_cursor."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_SET_CURSOR, _x_ ("Wrapper on lw6ker_set_cursor."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_DO_ROUND, _x_ ("Wrapper on lw6ker_do_round."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_MOVES, _x_ ("Wrapper on lw6ker_get_moves."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_SPREADS, _x_ ("Wrapper on lw6ker_get_spreads."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_ROUNDS, _x_ ("Wrapper on lw6ker_get_rounds."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_IS_OVER, _x_ ("Wrapper on lw6ker_is_over."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_DID_CURSOR_WIN, _x_ ("Wrapper on lw6ker_did_cursor_win."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_NB_COLORS, _x_ ("Wrapper on lw6ker_game_state_get_nb_colors."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_NB_CURSORS, _x_ ("Wrapper on lw6ker_game_state_get_nb_cursors."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6KER_GET_NB_NODES, _x_ ("Wrapper on lw6ker_game_state_get_nb_nodes."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GEN_CREATE_FROM_SEED, _x_ ("Wrapper on lw6gen_create_from_seed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GEN_SEED_NEW, _x_ ("Wrapper on lw6gen_seed_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6GEN_SEED_NORMALIZE, _x_ ("Wrapper on lw6gen_seed_normalize."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_BENCH, _x_ ("Wrapper on lw6pil_bench."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SEED_COMMAND_GENERATE, _x_ ("Wrapper on lw6pil_seed_command_generate."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_DUMP_COMMAND_GENERATE, _x_ ("Wrapper on lw6pil_dump_command_generate."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_POLL_DUMP, _x_ ("Wrapper on lw6pil_poll_dump."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_BUILD_PILOT, _x_ ("Wrapper on lw6pil_build_pilot."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SEND_COMMAND, _x_ ("Wrapper on lw6pil_send_command."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_LOCAL_COMMAND, _x_ ("Wrapper on lw6pil_local_command."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_COMMIT, _x_ ("Wrapper on lw6pil_commit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_FIX_COORDS, _x_ ("Wrapper on lw6pil_coords_fix."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_FIX_COORDS_X10, _x_ ("Wrapper on lw6pil_coords_fix_x10."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_EXECUTE_COMMAND, _x_ ("Wrapper on lw6pil_execute_command."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_LOCAL_CURSORS_SET_MAIN, _x_ ("Wrapper on lw6pil_local_cursors_set_main."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_LOCAL_CURSORS_SET_MOUSE_CONTROLLED, _x_ ("Wrapper on lw6pil_local_cursors_set_mouse_controlled."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_MAKE_BACKUP, _x_ ("Wrapper on lw6pil_make_backup."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SYNC_FROM_BACKUP, _x_ ("Wrapper on lw6pil_sync_from_backup."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SYNC_FROM_REFERENCE, _x_ ("Wrapper on lw6pil_sync_from_reference."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SYNC_FROM_DRAFT, _x_ ("Wrapper on lw6pil_sync_from_draft."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_CALIBRATE, _x_ ("Wrapper on lw6pil_calibrate."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SPEED_UP, _x_ ("Wrapper on lw6pil_speed_up."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SLOW_DOWN, _x_ ("Wrapper on lw6pil_slow_down."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_ROUND_0, _x_ ("Wrapper on lw6pil_get_round_0."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_SEQ_0, _x_ ("Wrapper on lw6pil_get_seq_0."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SEQ2ROUND, _x_ ("Wrapper on lw6pil_seq2round."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_ROUND2SEQ, _x_ ("Wrapper on lw6pil_round2seq."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_NEXT_SEQ, _x_ ("Wrapper on lw6pil_get_next_seq."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_LAST_COMMIT_SEQ, _x_ ("Wrapper on lw6pil_get_last_commit_seq."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_REFERENCE_CURRENT_SEQ, _x_ ("Wrapper on lw6pil_get_reference_current_seq."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_REFERENCE_TARGET_SEQ, _x_ ("Wrapper on lw6pil_get_reference_target_seq."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_MAX_SEQ, _x_ ("Wrapper on lw6pil_get_max_seq."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_IS_OVER, _x_ ("Wrapper on lw6pil_is_over."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_DID_CURSOR_WIN, _x_ ("Wrapper on lw6pil_did_cursor_win."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_WINNER, _x_ ("Wrapper on lw6pil_get_winner."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_GET_LOOSER, _x_ ("Wrapper on lw6pil_get_looser."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SEQ_RANDOM_0, _x_ ("Wrapper on lw6pil_seq_random_0."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SUITE_INIT, _x_ ("Wrapper on lw6pil_suite_init."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SUITE_GET_SEQ_0, _x_ ("Wrapper on lw6pil_suite_get_seq_0."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SUITE_GET_NODE_ID, _x_ ("Wrapper on lw6pil_suite_get_node_id."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SUITE_GET_COMMANDS_BY_NODE_INDEX,
		 _x_ ("Wrapper on lw6pil_suite_get_command_by_node_index, returns the list of all steps."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SUITE_GET_COMMANDS_BY_STAGE,
		 _x_ ("Wrapper on lw6pil_suite_get_command_by_stage, returns the list of all steps."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6PIL_SUITE_GET_CHECKPOINT, _x_ ("Wrapper on lw6pil_suite_get_checkpoint."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_GET_BACKENDS, _x_ ("Wrapper on lw6snd_get_backends."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_NEW, _x_ ("Wrapper on lw6snd_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_POLL, _x_ ("Wrapper on lw6snd_poll."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_RELEASE, _x_ ("Wrapper on lw6snd_release."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_PLAY_FX, _x_ ("Wrapper on lw6snd_play_fx."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_SET_FX_VOLUME, _x_ ("Wrapper on lw6snd_set_fx_volume."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_SET_WATER_VOLUME, _x_ ("Wrapper on lw6snd_set_water_volume."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_IS_MUSIC_FILE, _x_ ("Wrapper on lw6snd_is_music_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_PLAY_MUSIC_FILE, _x_ ("Wrapper on lw6snd_play_music_file."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_PLAY_MUSIC_RANDOM, _x_ ("Wrapper on lw6snd_play_music_random."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_STOP_MUSIC, _x_ ("Wrapper on lw6snd_stop_music."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SND_SET_MUSIC_VOLUME, _x_ ("Wrapper on lw6snd_set_music_volume."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CNS_CONSOLE_SUPPORT, _x_ ("Wrapper on lw6cns_console_support."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CNS_TERM_SUPPORT, _x_ ("Wrapper on lw6cns_term_support."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CNS_INIT, _x_ ("Wrapper on lw6cns_init."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CNS_QUIT, _x_ ("Wrapper on lw6cns_quit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CNS_POLL, _x_ ("Wrapper on lw6cns_poll."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6TSK_LOADER_NEW, _x_ ("Wrapper on lw6tsk_loader_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6TSK_LOADER_PUSH_GEN, _x_ ("Wrapper on lw6tsk_loader_push_gen."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6TSK_LOADER_PUSH_LDR, _x_ ("Wrapper on lw6tsk_loader_push_ldr."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6TSK_LOADER_POP, _x_ ("Wrapper on lw6tsk_loader_pop."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6TSK_LOADER_GET_STAGE, _x_ ("Wrapper on lw6tsk_loader_get_stage."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6IMG_SCREENSHOT, _x_ ("Wrapper on lw6img_screenshot."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6NET_INIT, _x_ ("Wrapper on lw6net_init."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6NET_QUIT, _x_ ("Wrapper on lw6net_quit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6CLI_GET_BACKENDS, _x_ ("Wrapper on lw6cli_get_backends."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6SRV_GET_BACKENDS, _x_ ("Wrapper on lw6srv_get_backends."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_DB_NEW, _x_ ("Wrapper on lw6p2p_db_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_DB_RESET, _x_ ("Wrapper on lw6p2p_db_reset."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_DB_DEFAULT_NAME, _x_ ("Wrapper on lw6p2p_db_default_name."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_NEW, _x_ ("Wrapper on lw6p2p_node_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_POLL, _x_ ("Wrapper on lw6p2p_node_poll."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_CLOSE, _x_ ("Wrapper on lw6p2p_node_close."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_ID, _x_ ("Wrapper on lw6p2p_node_get_id."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_ENTRIES, _x_ ("Wrapper on lw6p2p_node_get_entries."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_SERVER_START, _x_ ("Wrapper on lw6p2p_node_server_start."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_CLIENT_JOIN, _x_ ("Wrapper on lw6p2p_node_client_join."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_REFRESH_PEER, _x_ ("Wrapper on lw6p2p_node_refresh_peer."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_DISCONNECT, _x_ ("Wrapper on lw6p2p_node_disconnect."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_UPDATE_INFO, _x_ ("Wrapper on lw6p2p_node_update_info."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_CALIBRATE, _x_ ("Wrapper on lw6p2p_node_calibrate."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_LOCAL_SEQ_0, _x_ ("Wrapper on lw6p2p_node_get_local_seq_0."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_LOCAL_SEQ_LAST, _x_ ("Wrapper on lw6p2p_node_get_local_seq_last."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_SEQ_MIN, _x_ ("Wrapper on lw6p2p_node_get_seq_min."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_SEQ_MAX, _x_ ("Wrapper on lw6p2p_node_get_seq_max."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_SEQ_DRAFT, _x_ ("Wrapper on lw6p2p_node_get_seq_draft."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_SEQ_REFERENCE, _x_ ("Wrapper on lw6p2p_node_get_seq_reference."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_IS_PEER_CONNECTED, _x_ ("Wrapper on lw6p2p_node_is_peer_connected."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_IS_PEER_REGISTERED, _x_ ("Wrapper on lw6p2p_node_is_peer_registered."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_IS_SEED_NEEDED, _x_ ("Wrapper on lw6p2p_node_is_seed_needed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_IS_DUMP_NEEDED, _x_ ("Wrapper on lw6p2p_node_is_dump_needed."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_PUT_LOCAL_MSG, _x_ ("Wrapper on lw6p2p_node_put_local_msg."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_NEXT_REFERENCE_MSG, _x_ ("Wrapper on lw6p2p_node_get_next_reference_msg."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6P2P_NODE_GET_NEXT_DRAFT_MSG, _x_ ("Wrapper on lw6p2p_node_get_next_draft_msg."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6BOT_GET_BACKENDS, _x_ ("Wrapper on lw6bot_get_backends."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6BOT_NEW, _x_ ("Wrapper on lw6bot_new."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6BOT_NEXT_MOVE, _x_ ("Wrapper on lw6bot_next_move."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6_RELEASE, _x_ ("Wrapper on lw6_release."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6_EXIT, _x_ ("Wrapper on lw6_exit."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6_SET_RET, _x_ ("Wrapper on lw6_set_ret."));
  POPULATE_VOID (sys_context, LW6DEF_C_LW6_GET_RET, _x_ ("Wrapper on lw6_get_ret."));
  /*
   * Aliases
   */
  POPULATE_VOID (sys_context, "h", _x_ ("An alias for '--help'."));
  POPULATE_VOID (sys_context, "?", _x_ ("An alias for '--help'."));
  POPULATE_VOID (sys_context, "v", _x_ ("An alias for '--version'."));
  POPULATE_VOID (sys_context, "c", _x_ ("An alias for '--copyright'."));
  POPULATE_VOID (sys_context, LW6DEF_COPY, _x_ ("An alias for '--copyright'."));
  POPULATE_VOID (sys_context, LW6DEF_COPYLEFT, _x_ ("An alias for '--copyright'."));
  POPULATE_VOID (sys_context, LW6DEF_CFLAGS, _x_ ("An alias for '--show-build-cflags'."));
  POPULATE_VOID (sys_context, LW6DEF_LDFLAGS, _x_ ("An alias for '--show-build-ldflags'."));
  POPULATE_VOID (sys_context, LW6DEF_CONFIGURE_ARGS, _x_ ("An alias for '--show-build-configure-args'."));
  /*
   * team colors
   */
  // note: team colors need to be localized
  POPULATE_VOID (sys_context, LW6DEF_RED, _("moves faster than the average"));
  POPULATE_VOID (sys_context, LW6DEF_GREEN, _("has a better defense than the average"));
  POPULATE_VOID (sys_context, LW6DEF_BLUE, _("has a strong attack but is slow"));
  POPULATE_VOID (sys_context, LW6DEF_YELLOW, _("has a strong attack"));
  POPULATE_VOID (sys_context, LW6DEF_CYAN, _("has an extremely good defense but is slow"));
  POPULATE_VOID (sys_context, LW6DEF_MAGENTA, _("is extremely fast but also very vulnerable"));
  POPULATE_VOID (sys_context, LW6DEF_ORANGE, _("is fast, but has a very weak attack"));
  POPULATE_VOID (sys_context, LW6DEF_LIGHTBLUE, _("has an extremely strong attack but is very slow"));
  POPULATE_VOID (sys_context, LW6DEF_PURPLE, _("has a very good defense but a weak attack"));
  POPULATE_VOID (sys_context, LW6DEF_PINK, _("has a very strong attack, but is also very vulnerable"));
  /*
   * weapons
   */
  // note: weapons need to be localized
  POPULATE_VOID (sys_context, LW6DEF_BERZERK, _("super-strong attack for a limited time, crush your enemies"));
  POPULATE_VOID (sys_context, LW6DEF_INVINCIBLE, _("no damage for a limited time, move untouched"));
  POPULATE_VOID (sys_context, LW6DEF_ESCAPE, _("fighters placed as far as possible from cursor, magically escape from any grip"));
  POPULATE_VOID (sys_context, LW6DEF_TURBO, _("move faster for a limited time"));
  POPULATE_VOID (sys_context, LW6DEF_TELEPORT, _("fighters placed as close as possible to cursor"));
  POPULATE_VOID (sys_context, LW6DEF_SCATTER, _("every fighters of every team scattered in random places"));
  POPULATE_VOID (sys_context, LW6DEF_FIX, _("all other teams are freezed, you can move but not attack them"));
  POPULATE_VOID (sys_context, LW6DEF_MIX, _("fighters exchange position, their properties being preserved"));
  POPULATE_VOID (sys_context, LW6DEF_CONTROL, _("you take the control of all other teams while your cursor stays in place"));
  POPULATE_VOID (sys_context, LW6DEF_PERMUTATION, _("will exchange colors, randomly, requires at least 3 teams (double edged weapon)"));
  POPULATE_VOID (sys_context, LW6DEF_STEAL, _("steals some fighters to other teams"));
  POPULATE_VOID (sys_context, LW6DEF_ATOMIC, _("nuclear explosion, all fighters arround your cursor are about to die"));
  POPULATE_VOID (sys_context, LW6DEF_REVERSE, _("fighters continue to move normally, but attacks are done in reverse mode, backwards"));
  POPULATE_VOID (sys_context, LW6DEF_CRAZY, _("all your opponents go crazy for some time, acting with no logic"));
  POPULATE_VOID (sys_context, LW6DEF_REWIND, _("make the battlefield be like it was a few seconds ago"));
  POPULATE_VOID (sys_context, LW6DEF_ATTRACT, _("all fighters from all teams are packed near your cursor"));
  POPULATE_VOID (sys_context, LW6DEF_SHRINK, _("reduces the number of fighters on the map"));
  POPULATE_VOID (sys_context, LW6DEF_KAMIKAZE, _("you die along with the strongest team on the battlefield, requires at least 3 teams"));
  POPULATE_VOID (sys_context, LW6DEF_DISAPPEAR, _("you disappear for some time from the battlefield, to reappear later, somewhere else"));
  POPULATE_VOID (sys_context, LW6DEF_PLAGUE, _("general disease, all fighters mysteriously loose health"));
  ret = 1;
  return ret;
}
  ...
  if (!_references)
    {
      ...
      if (_references)
	{
	  ret = _populate_references (sys_context);
	}
    }
  else
    {
