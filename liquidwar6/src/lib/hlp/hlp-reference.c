...
new_reference (lw6hlp_type_t type, const char *key, const char *about, const char *default_value, int min_value, int max_value)
{
...
populate_references ()
{
  ...
  POPULATE_VOID (LW6DEF_COPYRIGHT, _x_ ("Returns the copyright notice for the program."));
  POPULATE_VOID (LW6DEF_VERSION, _x_ ("Returns the version of the program, as defined by the GNU Coding Standards."));
  ...
  POPULATE_VOID (LW6DEF_HOST, _x_ ("Display all known system host properties, including os and cpu informations."));
  ...
  POPULATE_VOID (LW6DEF_CREDITS, _x_ ("Gives hopefully extensive information on who contributed to the game."));
  /*
   * Advanced doc
   */
  POPULATE_VOID (LW6DEF_LIST_QUICK, _x_ ("List quick help entries, this includes the GNU standard options and a few troubleshooting tools."));
  ...
  POPULATE_VOID (LW6DEF_LIST_PLAYERS, _x_ ("List player-related entries, that is to say 'who plays'."));
  POPULATE_VOID (LW6DEF_LIST_INPUT, _x_ ("List input (AKA controls) related options. Use these to change keyboard, joystick and mouse settingds."));
  POPULATE_VOID (LW6DEF_LIST_GRAPHICS, _x_ ("List graphics options (resolution, fullscreen...)."));
  POPULATE_VOID (LW6DEF_LIST_SOUND, _x_ ("List sound options (volume...)."));
  POPULATE_VOID (LW6DEF_LIST_NETWORK, _x_ ("List network options."));
  POPULATE_VOID (LW6DEF_LIST_MAP, _x_ ("List map-related entries, excluding rules.xml, hints.xml and style.xml entries."));
  POPULATE_VOID (LW6DEF_LIST_MAP_RULES, _x_ ("List 'options.xml' entries. These parameters enable you to modify the gameplay."));
  POPULATE_VOID (LW6DEF_LIST_MAP_HINTS, _x_ ("List 'hints.xml' entries. These parameters enable you to modify the behavior of the map loader."));
  POPULATE_VOID (LW6DEF_LIST_MAP_STYLE, _x_ ("List 'style.xml' entries. These parameters enable you to modify the aspect of the game."));
  POPULATE_VOID (LW6DEF_LIST_MAP_TEAMS, _x_ ("List 'teams.xml' entries. These parameters enable you to specify which teams should play on the map."));
  POPULATE_VOID (LW6DEF_LIST_FUNCS, _x_ ("List the C-functions which are exported to Guile, thus usable in scripts."));
  POPULATE_VOID (LW6DEF_LIST_HOOKS, _x_ ("List user-modifiable hooks."));
  POPULATE_VOID (LW6DEF_LIST_ADVANCED, _x_ ("List advanced options which can be used for fine-tuning the game."));
  POPULATE_VOID (LW6DEF_LIST_ALIASES, _x_ ("List the keyword aliases. These are here for convenience."));
  POPULATE_VOID (LW6DEF_LIST_TEAM_COLORS, _x_ ("List the team colors, there should be 10 of them"));
   ...
   * Build values
   */
  POPULATE_VOID (LW6DEF_SHOW_BUILD_PACKAGE_TARNAME, _x_ ("Shows the package tarname, that is, liquidwar6."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_PACKAGE_NAME, _x_ ("Shows the package name, that is, 'Liquid War 6'."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_PACKAGE_STRING, _x_ ("Shows the package string, that is, 'Liquid War 6 <version>"));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_PACKAGE_ID, _x_ ("Shows the package tarname with its version, that is, 'liquidwar6-<version>"));
  ...
  POPULATE_VOID (LW6DEF_SHOW_BUILD_COPYRIGHT, _x_ ("Shows a very short copyright notice."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_LICENSE, _x_ ("Shows the license of the program (GNU GPL v3 or later)."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_HOME_URL, _x_ ("Shows the URL of the program, its homepage."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_BUGS_URL, _x_ ("Shows the URL to make bug reports."));
  ...
  POPULATE_VOID (LW6DEF_SHOW_BUILD_GCC_VERSION, _x_ ("Returns the version of the GNU C compiler which was used to compile the program."));
  ...
  POPULATE_VOID (LW6DEF_SHOW_BUILD_HOSTNAME, _x_ ("Shows the name of the host where the binary was compiled."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_DATE, _x_ ("Shows the date when the binary was compiled."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_TIME, _x_ ("Shows the time when the binary was compiled."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_HOST_CPU, _x_ ("Shows the host CPU, as defined by 'host_cpu' in GNU Autoconf."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_ENDIANNESS, _x_ ("Returns the endianness. 'little' corresponds to x86-like systems, 'big' to ppc-like systems."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_POINTER_SIZE, _x_ ("Returns the pointer size, in bytes. Should be 4 on 32-bit systems and 8 on 64-bit systems."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_X86, _x_ ("Tells wether the CPU belongs to x86 family."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_HOST_OS, _x_ ("Shows the host OS, as defined by 'host_os' in GNU Autoconf."));
  ...
  POPULATE_VOID (LW6DEF_SHOW_BUILD_MS_WINDOWS, _x_ ("Returns 1 (true) if host OS is Microsoft Windows, 0 (false) if not."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_MAC_OS_X, _x_ ("Returns 1 (true) if host OS is Mac OS X, 0 (false) if not."));
  POPULATE_VOID (LW6DEF_SHOW_BUILD_GP2X, _x_ ("Returns 1 (true) if host is a GP2X, 0 (false) if not."));
  ...
  POPULATE_VOID (LW6DEF_SHOW_BUILD_ABS_SRCDIR, _x_ ("Shows the top source directory on the machine where the binary was compiled, as an absolute path."));
  ...
  POPULATE_VOID (LW6DEF_SHOW_DEFAULT_CONFIG_FILE, _x_ ("Shows the default config file path. Default is '$HOME/.liquidwar6/config.xml'."));
  POPULATE_VOID (LW6DEF_SHOW_DEFAULT_LOG_FILE, _x_ ("Shows the default log file path. Default is '$HOME/.liquidwar6/log.csv'."));
   ...
   * Show paths
   */
  POPULATE_VOID (LW6DEF_SHOW_CWD, _x_ ("Shows the current working directory, the value that the pwd command would return."));
  ...
  POPULATE_VOID (LW6DEF_SHOW_CONFIG_FILE, _x_ ("Shows the config file path. Default is '$HOME/.liquidwar6/config.xml'."));
  POPULATE_VOID (LW6DEF_SHOW_LOG_FILE, _x_ ("Shows the log file path. Default is '$HOME/.liquidwar6/log.csv'."));
  ...
  POPULATE_STR (LW6DEF_PLAYER3_NAME, _x_ ("Name of the third player. A default value is provided, you'll certainly want to change it."), "player3-<hostname>");
  ...
  POPULATE_BOOL (LW6DEF_PLAYER1_STATUS, _x_ ("Status of the first player, true if player is activated, false if idle."), 1);
  POPULATE_BOOL (LW6DEF_PLAYER2_STATUS, _x_ ("Status of the second player, true if player is activated, false if idle."), 1);
  POPULATE_BOOL (LW6DEF_PLAYER3_STATUS, _x_ ("Status of the third player, true if player is activated, false if idle."), 0);
  POPULATE_BOOL (LW6DEF_PLAYER4_STATUS, _x_ ("Status of the fourth player, true if player is activated, false if idle."), 0);
  POPULATE_STR (LW6DEF_PLAYER1_CONTROL, _x_ ("Control for the first player, must be mouse, keyboard, joystick1, joystick2 or custom."), "mouse");
  POPULATE_STR (LW6DEF_PLAYER2_CONTROL, _x_ ("Control for the second player, must be mouse, keyboard, joystick1, joystick2 or custom."), "keyboard");
  POPULATE_STR (LW6DEF_PLAYER3_CONTROL, _x_ ("Control for the third player, must be mouse, keyboard, joystick1, joystick2 or custom."), "joystick1");
  POPULATE_STR (LW6DEF_PLAYER4_CONTROL, _x_ ("Control for the fourth player, must be mouse, keyboard, joystick1, joystick2 or custom."), "joystick2");
  /*
   * Input
   */
  ...
  POPULATE_INT (LW6DEF_REPEAT_DELAY, _x_ ("Time, in milliseconds, before key repeat will start, use 0 to disable."), 500, 0, 0);
  POPULATE_INT (LW6DEF_REPEAT_INTERVAL, _x_ ("Time, in milliseconds, between two repeats, once repeat has started, use 0 to disable."), 100, 0, 0);
  POPULATE_INT (LW6DEF_DOUBLE_CLICK_DELAY, _x_ ("Time, in milliseconds, determining wether two consecutive clicks make a double-click or not."), 333, 0, 0);
  ...
  POPULATE_BOOL (LW6DEF_USE_DOUBLE_CLICK,
		 ...
		 0);
  POPULATE_STR (LW6DEF_CUSTOM_UP, _x_ ("Custom keycode to be used as the UP key equivalent."), "(c-lw6gui-keyboard-is-pressed 101) ; SDLK_e");
  POPULATE_STR (LW6DEF_CUSTOM_DOWN, _x_ ("Guile custom code associated to the DOWN key equivalent."), "(c-lw6gui-keyboard-is-pressed 100) ; SDLK_d");
  POPULATE_STR (LW6DEF_CUSTOM_LEFT, _x_ ("Guile custom code associated to the LEFT key equivalent."), "(c-lw6gui-keyboard-is-pressed 99) ; SDLK_c");
  POPULATE_STR (LW6DEF_CUSTOM_RIGHT, _x_ ("Guile custom code associated to the RIGHT key equivalent."), "(c-lw6gui-keyboard-is-pressed 118) ; SDLK_v");
  POPULATE_STR (LW6DEF_CUSTOM_ENTER, _x_ ("Guile custom code associated to the ENTER key equivalent."), "(c-lw6gui-keyboard-is-pressed 103) ; SDLK_g");
  POPULATE_STR (LW6DEF_CUSTOM_ESC, _x_ ("Guile custom code associated to the ESC key equivalent."), "(c-lw6gui-keyboard-is-pressed 102) ; SDLK_f");
  POPULATE_STR (LW6DEF_CUSTOM_CTRL, _x_ ("Guile custom code associated to the CTRL key equivalent."), "(c-lw6gui-keyboard-is-pressed 98) ; SDLK_b");
  POPULATE_STR (LW6DEF_CUSTOM_ALT, _x_ ("Guile custom code associated to the ALT key equivalent."), "(c-lw6gui-keyboard-is-pressed 110) ; SDLK_n");
  POPULATE_STR (LW6DEF_CUSTOM_PGUP, _x_ ("Guile custom code associated to the PGUP key equivalent."), "(c-lw6gui-keyboard-is-pressed 119) ; SDLK_w");
  POPULATE_STR (LW6DEF_CUSTOM_PGDOWN, _x_ ("Guile custom code associated to the PGDOWN key equivalent."), "(c-lw6gui-keyboard-is-pressed 115) ; SDLK_s");
  ...
  POPULATE_FLOAT (LW6DEF_ZOOM_STICK_DELAY, _x_ ("How long, in msec, the zoom will stick to its default value."), 1000, 0, 0);
  /*
   * Graphics
   */
   ...
   * Sound
   */
  POPULATE_FLOAT (LW6DEF_FX_VOLUME, _x_ ("Set the sound effects volume. This is a floating point value. 0 is mute. Maximum value is 1."), 0.3, 0, 1);
  POPULATE_FLOAT (LW6DEF_WATER_VOLUME, _x_ ("Set the volume for water sounds. This is a floating point value. 0 is mute. Maximum value is 1."), 0.2, 0, 1);
  POPULATE_FLOAT (LW6DEF_MUSIC_VOLUME, _x_ (" Set the music volume.This is a floating point value. 0 is mute. Maximum value is 1."), 0.6, 0, 1);
  ...
  POPULATE_BOOL (LW6DEF_RESET_CONFIG_ON_UPGRADE, _x_ ("If set, then a reset (config file set to defaults) is run every time you upgrade the game."), 1);
  ...
  POPULATE_BOOL (LW6DEF_MEMORY_BAZOOKA_ERASER,
		 ...
		 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_SPLASH, _x_ ("Set this to 'false' to disable the display of the splash screen at game startup."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_BACKGROUND, _x_ ("Decides wether the background animation/image should be displayed at all."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_PREVIEW, _x_ ("Decides wether a map preview should be displayed when choosing a level."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_MAP, _x_ ("Debugging option which can be set to 'false' to disable map (level) display when playing."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_FIGHTERS, _x_ ("Debugging option which can be set to 'false' to disable the display of fighters when playing."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_CURSORS, _x_ ("Debugging option which can be set to 'false' to disable the display of cursors when playing."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_HUD, _x_ ("Decides wether the hud (informations while playing) should be displayed."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_SCORE, _x_ ("Decides wether the score screen should be displayed."), 1);
  POPULATE_BOOL (LW6DEF_DISPLAY_MENU, _x_ ("Debugging option which can be set to 'false' to disable the display of menus."), 1);
  ...
  POPULATE_BOOL (LW6DEF_DISPLAY_URL,
		 ...
		 0);
  POPULATE_BOOL (LW6DEF_DISPLAY_MOUSE, _x_ ("Set this to 'false' to always hide the mouse pointer."), 1);
  ...
  POPULATE_VOID (LW6DEF_QUICK_START, _x_ ("Start the game just like if the player had requested a quick start, without showing any menu."));
  POPULATE_VOID (LW6DEF_DEMO, _x_ ("Start the game in demo mode. 2 bots play against each other forever."));
  ...
  POPULATE_INT (LW6DEF_LOG_TIMEOUT, _x_ ("Delay, in msec, for which a log message will stay displayed on the screen."), 5000, 0, 0);
  ...
  POPULATE_BOOL (LW6DEF_USE_RULES_XML,
		 ...
		 1);
  POPULATE_BOOL (LW6DEF_USE_HINTS_XML, _x_ ("If set, then hints will be picked up from the map defined hints.xml, if it exists. This is the default."), 1);
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_RED_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_GREEN_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_BLUE_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_YELLOW_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_CYAN_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_MAGENTA_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_ORANGE_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_LIGHTBLUE_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_PURPLE_HANDICAP,
		_x_
  ...
  POPULATE_INT (LW6DEF_TEAM_PROFILE_PINK_HANDICAP,
		_x_
  ...
  POPULATE_BOOL (LW6DEF_WAVES, _x_ ("Activates the wave effect, that's to say level appears to be under water when playing."), LW6MAP_STYLE_DEFAULT_WAVES);
  /*
   * Map teams
   */
  ...
  POPULATE_STR (LW6DEF_BOT1_COLOR, _x_ ("Color for bot number 1."), LW6MAP_TEAMS_DEFAULT_BOT1_COLOR);
  POPULATE_STR (LW6DEF_BOT2_COLOR, _x_ ("Color for bot number 2."), LW6MAP_TEAMS_DEFAULT_BOT2_COLOR);
  POPULATE_STR (LW6DEF_BOT3_COLOR, _x_ ("Color for bot number 3."), LW6MAP_TEAMS_DEFAULT_BOT3_COLOR);
  POPULATE_STR (LW6DEF_BOT4_COLOR, _x_ ("Color for bot number 4."), LW6MAP_TEAMS_DEFAULT_BOT4_COLOR);
  POPULATE_STR (LW6DEF_BOT5_COLOR, _x_ ("Color for bot number 5."), LW6MAP_TEAMS_DEFAULT_BOT5_COLOR);
  POPULATE_STR (LW6DEF_BOT6_COLOR, _x_ ("Color for bot number 6."), LW6MAP_TEAMS_DEFAULT_BOT6_COLOR);
  POPULATE_STR (LW6DEF_BOT7_COLOR, _x_ ("Color for bot number 7."), LW6MAP_TEAMS_DEFAULT_BOT7_COLOR);
  POPULATE_STR (LW6DEF_BOT8_COLOR, _x_ ("Color for bot number 8."), LW6MAP_TEAMS_DEFAULT_BOT8_COLOR);
  POPULATE_STR (LW6DEF_BOT9_COLOR, _x_ ("Color for bot number 9."), LW6MAP_TEAMS_DEFAULT_BOT9_COLOR);
  POPULATE_STR (LW6DEF_BOT1_AI, _x_ ("AI engine for bot number 1."), LW6MAP_TEAMS_DEFAULT_BOT1_AI);
  POPULATE_STR (LW6DEF_BOT2_AI, _x_ ("AI engine for bot number 2."), LW6MAP_TEAMS_DEFAULT_BOT2_AI);
  POPULATE_STR (LW6DEF_BOT3_AI, _x_ ("AI engine for bot number 3."), LW6MAP_TEAMS_DEFAULT_BOT3_AI);
  POPULATE_STR (LW6DEF_BOT4_AI, _x_ ("AI engine for bot number 4."), LW6MAP_TEAMS_DEFAULT_BOT4_AI);
  POPULATE_STR (LW6DEF_BOT5_AI, _x_ ("AI engine for bot number 5."), LW6MAP_TEAMS_DEFAULT_BOT5_AI);
  POPULATE_STR (LW6DEF_BOT6_AI, _x_ ("AI engine for bot number 6."), LW6MAP_TEAMS_DEFAULT_BOT6_AI);
  POPULATE_STR (LW6DEF_BOT7_AI, _x_ ("AI engine for bot number 7."), LW6MAP_TEAMS_DEFAULT_BOT7_AI);
  POPULATE_STR (LW6DEF_BOT8_AI, _x_ ("AI engine for bot number 8."), LW6MAP_TEAMS_DEFAULT_BOT8_AI);
  POPULATE_STR (LW6DEF_BOT9_AI, _x_ ("AI engine for bot number 9."), LW6MAP_TEAMS_DEFAULT_BOT9_AI);
  /*
   * Funcs
   */
  ...
  POPULATE_VOID (LW6DEF_C_LW6SYS_SET_MEMORY_BAZOOKA_SIZE, _x_ ("Wrapper on lw6sys_set_memory_bazooka_size."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MEMORY_BAZOOKA_SIZE, _x_ ("Wrapper on lw6sys_get_memory_bazooka_size."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_SET_MEMORY_BAZOOKA_ERASER, _x_ ("Wrapper on lw6sys_set_memory_bazooka_eraser."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MEMORY_BAZOOKA_ERASER, _x_ ("Wrapper on lw6sys_get_memory_bazooka_eraser."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_TARNAME, _x_ ("Wrapper on lw6sys_build_get_package_tarname."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_NAME, _x_ ("Wrapper on lw6sys_build_get_package_name."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_STRING, _x_ ("Wrapper on lw6sys_build_get_package_string."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_PACKAGE_ID, _x_ ("Wrapper on lw6sys_build_get_package_id."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_VERSION, _x_ ("Wrapper on lw6sys_build_get_version."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_CODENAME, _x_ ("Wrapper on lw6sys_build_get_codename."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_VERSION_BASE, _x_ ("Wrapper on lw6sys_build_get_version_base."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_VERSION_MAJOR, _x_ ("Wrapper on lw6sys_build_get_version_major."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_VERSION_MINOR, _x_ ("Wrapper on lw6sys_build_get_version_minor."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_STAMP, _x_ ("Wrapper on lw6sys_build_get_stamp."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_MD5SUM, _x_ ("Wrapper on lw6sys_build_get_md5sum."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_COPYRIGHT, _x_ ("Wrapper on lw6sys_build_get_copyright."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_LICENSE, _x_ ("Wrapper on lw6sys_build_get_license."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_HOME_URL, _x_ ("Wrapper on lw6sys_build_get_home_url."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_BUGS_URL, _x_ ("Wrapper on lw6sys_build_get_bugs_url."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_CONFIGURE_ARGS, _x_ ("Wrapper on lw6sys_build_get_configure_args."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_GCC_VERSION, _x_ ("Wrapper on lw6sys_build_get_gcc_version."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_CFLAGS, _x_ ("Wrapper on lw6sys_build_get_cflags."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_LDFLAGS, _x_ ("Wrapper on lw6sys_build_get_ldflags."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_HOSTNAME, _x_ ("Wrapper on lw6sys_build_get_hostname."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_DATE, _x_ ("Wrapper on lw6sys_build_get_date."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_TIME, _x_ ("Wrapper on lw6sys_build_get_time."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_HOST_CPU, _x_ ("Wrapper on lw6sys_build_get_host_cpu."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENDIANNESS, _x_ ("Wrapper on lw6sys_build_get_endianness."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_POINTER_SIZE, _x_ ("Wrapper on lw6sys_build_get_pointer_size."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_IS_X86, _x_ ("Wrapper on lw6sys_build_is_x86."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_HOST_OS, _x_ ("Wrapper on lw6sys_build_get_host_os."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_IS_GNU, _x_ ("Wrapper on lw6sys_build_is_gnu."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_IS_UNIX, _x_ ("Wrapper on lw6sys_build_is_unix."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_IS_MS_WINDOWS, _x_ ("Wrapper on lw6sys_build_is_ms_windows."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_IS_MAC_OS_X, _x_ ("Wrapper on lw6sys_build_is_mac_os_x."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_IS_GP2X, _x_ ("Wrapper on lw6sys_build_is_gp2x."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_TOP_SRCDIR, _x_ ("Wrapper on lw6sys_build_get_top_srcdir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ABS_SRCDIR, _x_ ("Wrapper on lw6sys_build_get_abs_srcdir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_PREFIX, _x_ ("Wrapper on lw6sys_build_get_prefix."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_DATADIR, _x_ ("Wrapper on lw6sys_build_get_datadir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_LIBDIR, _x_ ("Wrapper on lw6sys_build_get_libdir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_INCLUDEDIR, _x_ ("Wrapper on lw6sys_build_get_includedir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_LOCALEDIR, _x_ ("Wrapper on lw6sys_build_get_localedir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_DOCDIR, _x_ ("Wrapper on lw6sys_build_get_docdir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_CONSOLE, _x_ ("Wrapper on lw6sys_build_get_enable_console."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_GTK, _x_ ("Wrapper on lw6sys_build_get_enable_gtk."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_GL1, _x_ ("Wrapper on lw6sys_build_get_enable_mod_gl1."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_GLES2, _x_ ("Wrapper on lw6sys_build_get_enable_mod_gles2."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_SOFT, _x_ ("Wrapper on lw6sys_build_get_enable_mod_soft."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_CACA, _x_ ("Wrapper on lw6sys_build_get_enable_mod_caca."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_CSOUND, _x_ ("Wrapper on lw6sys_build_get_enable_mod_csound."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_OGG, _x_ ("Wrapper on lw6sys_build_get_enable_mod_ogg."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_MOD_HTTP, _x_ ("Wrapper on lw6sys_build_get_enable_mod_http."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_OPENMP, _x_ ("Wrapper on lw6sys_build_get_enable_openmp."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_OPTIMIZE, _x_ ("Wrapper on lw6sys_build_get_enable_optimize."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_ALLINONE, _x_ ("Wrapper on lw6sys_build_get_enable_allinone."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_FULLSTATIC, _x_ ("Wrapper on lw6sys_build_get_enable_fullstatic."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_PARANOID, _x_ ("Wrapper on lw6sys_build_get_enable_paranoid."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_GPROF, _x_ ("Wrapper on lw6sys_build_get_enable_gprof."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_INSTRUMENT, _x_ ("Wrapper on lw6sys_build_get_enable_instrument."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_PROFILER, _x_ ("Wrapper on lw6sys_build_get_enable_profiler."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_GCOV, _x_ ("Wrapper on lw6sys_build_get_enable_gcov."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_ENABLE_VALGRIND, _x_ ("Wrapper on lw6sys_build_get_enable_valgrind."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_BUILD_GET_BIN_ID, _x_ ("Wrapper on lw6sys_build_get_bin_id."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_DEBUG_GET, _x_ ("Wrapper on lw6sys_debug_get."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_DEBUG_SET, _x_ ("Wrapper on lw6sys_debug_set."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_DUMP, _x_ ("Wrapper on lw6sys_dump."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_DUMP_CLEAR, _x_ ("Wrapper on lw6sys_dump_clear."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_USERNAME, _x_ ("Wrapper on lw6sys_get_username."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_HOSTNAME, _x_ ("Wrapper on lw6sys_get_hostname."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GETENV, _x_ ("Wrapper on lw6sys_getenv."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GETENV_PREFIXED, _x_ ("Wrapper on lw6sys_getenv_prefixed."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GENERATE_ID_16, _x_ ("Wrapper on lw6sys_generate_id_16."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GENERATE_ID_32, _x_ ("Wrapper on lw6sys_generate_id_32."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GENERATE_ID_64, _x_ ("Wrapper on lw6sys_generate_id_64."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_LOG, _x_ ("Wrapper on lw6sys_log."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_LOG_SET_DIALOG_TIMEOUT, _x_ ("Wrapper on lw6sys_log_set_dialog_timeout."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_LOG_GET_LEVEL, _x_ ("Wrapper on lw6sys_log_get_level."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_LOG_SET_LEVEL, _x_ ("Wrapper on lw6sys_log_set_level."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_LOG_GET_BACKTRACE_MODE, _x_ ("Wrapper on lw6sys_log_get_backtrace_mode."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_LOG_SET_BACKTRACE_MODE, _x_ ("Wrapper on lw6sys_log_set_backtrace_mode."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_MEGABYTES_AVAILABLE, _x_ ("Wrapper on lw6sys_megabytes_available."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_OPENMP_GET_NUM_PROCS, _x_ ("Wrapper on lw6sys_openmp_get_num_procs."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_USER_DIR, _x_ ("Wrapper on lw6sys_get_default_user_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_CONFIG_FILE, _x_ ("Wrapper on lw6sys_get_default_config_file."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_LOG_FILE, _x_ ("Wrapper on lw6sys_get_default_log_file."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_PREFIX, _x_ ("Wrapper on lw6sys_get_default_prefix."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_MOD_DIR, _x_ ("Wrapper on lw6sys_get_default_mod_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_DATA_DIR, _x_ ("Wrapper on lw6sys_get_default_data_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_MUSIC_DIR, _x_ ("Wrapper on lw6sys_get_default_music_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_MUSIC_PATH, _x_ ("Wrapper on lw6sys_get_default_music_path."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_MAP_DIR, _x_ ("Wrapper on lw6sys_get_default_map_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_MAP_PATH, _x_ ("Wrapper on lw6sys_get_default_map_path."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DEFAULT_SCRIPT_FILE, _x_ ("Wrapper on lw6sys_get_default_script_file."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_CWD, _x_ ("Wrapper on lw6sys_get_cwd."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_RUN_DIR, _x_ ("Wrapper on lw6sys_get_run_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_USER_DIR, _x_ ("Wrapper on lw6sys_get_user_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_CONFIG_FILE, _x_ ("Wrapper on lw6sys_get_config_file."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_LOG_FILE, _x_ ("Wrapper on lw6sys_get_log_file."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_PREFIX, _x_ ("Wrapper on lw6sys_get_prefix."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MOD_DIR, _x_ ("Wrapper on lw6sys_get_mod_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_DATA_DIR, _x_ ("Wrapper on lw6sys_get_data_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MUSIC_DIR, _x_ ("Wrapper on lw6sys_get_music_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MUSIC_PATH, _x_ ("Wrapper on lw6sys_get_music_path."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MAP_DIR, _x_ ("Wrapper on lw6sys_get_map_dir."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_MAP_PATH, _x_ ("Wrapper on lw6sys_get_map_path."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_SCRIPT_FILE, _x_ ("Wrapper on lw6sys_get_script_file."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_PATH_CONCAT, _x_ ("Wrapper on lw6sys_path_concat."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_PATH_FILE_ONLY, _x_ ("Wrapper on lw6sys_path_file_only."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_PATH_PARENT, _x_ ("Wrapper on lw6sys_path_parent."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_PATH_SPLIT, _x_ ("Wrapper on lw6sys_path_split."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_SIGNAL_CUSTOM, _x_ ("Wrapper on lw6sys_signal_custom."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_SIGNAL_DEFAULT, _x_ ("Wrapper on lw6sys_signal_default."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_SIGNAL_SEND_QUIT, _x_ ("Wrapper on lw6sys_signal_send_quit."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_SIGNAL_POLL_QUIT, _x_ ("Wrapper on lw6sys_signal_poll_quit."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_TIMESTAMP, _x_ ("Wrapper on lw6sys_get_timestamp."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_UPTIME, _x_ ("Wrapper on lw6sys_get_uptime."));
  POPULATE_VOID (LW6DEF_C_LW6SYS_GET_CYCLE, _x_ ("Wrapper on lw6sys_get_cycle."));
  ...
  POPULATE_VOID (LW6DEF_C_LW6SYS_URL_CANONIZE, _x_ ("Wrapper on lw6sys_url_canonize."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_ABOUT, _x_ ("Wrapper on lw6hlp_about."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_GET_DEFAULT_VALUE, _x_ ("Wrapper on lw6hlp_get_default_value."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_QUICK, _x_ ("Wrapper on lw6hlp_list_quick."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_DOC, _x_ ("Wrapper on lw6hlp_list_doc."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_SHOW, _x_ ("Wrapper on lw6hlp_list_show."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_PATH, _x_ ("Wrapper on lw6hlp_list_path."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_PLAYERS, _x_ ("Wrapper on lw6hlp_list_players."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_INPUT, _x_ ("Wrapper on lw6hlp_list_input."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_GRAPHICS, _x_ ("Wrapper on lw6hlp_list_graphics."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_SOUND, _x_ ("Wrapper on lw6hlp_list_sound."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_NETWORK, _x_ ("Wrapper on lw6hlp_list_network."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_MAP, _x_ ("Wrapper on lw6hlp_list_map."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_MAP_RULES, _x_ ("Wrapper on lw6hlp_list_map_rules."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_MAP_HINTS, _x_ ("Wrapper on lw6hlp_list_map_hints."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_MAP_STYLE, _x_ ("Wrapper on lw6hlp_list_map_style."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_MAP_TEAMS, _x_ ("Wrapper on lw6hlp_list_map_teams."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_FUNCS, _x_ ("Wrapper on lw6hlp_list_funcs."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_HOOKS, _x_ ("Wrapper on lw6hlp_list_hooks."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_ADVANCED, _x_ ("Wrapper on lw6hlp_list_advanced."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_ALIASES, _x_ ("Wrapper on lw6hlp_list_aliases."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_TEAM_COLORS, _x_ ("Wrapper on lw6hlp_list_team_colors."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST_WEAPONS, _x_ ("Wrapper on lw6hlp_list_weapons."));
  POPULATE_VOID (LW6DEF_C_LW6HLP_LIST, _x_ ("Wrapper on lw6hlp_list."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_DEFAULTS, _x_ ("Wrapper on lw6cfg_defaults."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_LOAD, _x_ ("Wrapper on lw6cfg_load."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_OPTION_EXISTS, _x_ ("Wrapper on lw6cfg_option_exists."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_GET_OPTION, _x_ ("Wrapper on lw6cfg_get_option."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_SET_OPTION, _x_ ("Wrapper on lw6cfg_set_option."));
  ...
  POPULATE_VOID (LW6DEF_C_LW6CFG_UNIFIED_GET_USER_DIR, _x_ ("Wrapper on lw6cfg_unified_get_user_dir."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_UNIFIED_GET_LOG_FILE, _x_ ("Wrapper on lw6cfg_unified_get_log_file."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_UNIFIED_GET_MUSIC_PATH, _x_ ("Wrapper on lw6cfg_unified_get_music_path."));
  POPULATE_VOID (LW6DEF_C_LW6CFG_UNIFIED_GET_MAP_PATH, _x_ ("Wrapper on lw6cfg_unified_get_map_path."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_NEW, _x_ ("Wrapper on lw6gui_menu_new."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_APPEND, _x_ ("Wrapper on lw6gui_menu_append."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_REMOVE, _x_ ("Wrapper on lw6gui_menu_remove."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_REMOVE_ALL, _x_ ("Wrapper on lw6gui_menu_remove_all."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_SYNC, _x_ ("Wrapper on lw6gui_menu_sync."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_SELECT, _x_ ("Wrapper on lw6gui_menu_select."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_SELECT_ESC, _x_ ("Wrapper on lw6gui_menu_select_esc."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_ENABLE_ESC, _x_ ("Wrapper on lw6gui_menu_enable_esc."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_SCROLL_UP, _x_ ("Wrapper on lw6gui_menu_scroll_up."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_SCROLL_DOWN, _x_ ("Wrapper on lw6gui_menu_scroll_down."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_SET_BREADCRUMBS, _x_ ("Wrapper on lw6gui_menu_set_breadcrumbs."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_CLOSE_POPUP, _x_ ("Wrapper on lw6gui_menu_close_popup."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MENU_HAS_POPUP, _x_ ("Wrapper on lw6gui_menu_has_popup."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_DEFAULT_LOOK, _x_ ("Wrapper on lw6gui_default_look."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_LOOK_SET, _x_ ("Wrapper on lw6gui_look_set."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_LOOK_GET, _x_ ("Wrapper on lw6gui_look_get."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_LOOK_ZOOM_IN, _x_ ("Wrapper on lw6gui_look_zoom_in."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_LOOK_ZOOM_OUT, _x_ ("Wrapper on lw6gui_look_zoom_out."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_INPUT_RESET, _x_ ("Wrapper on lw6gui_input_reset."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POLL_MOVE, _x_ ("Wrapper on lw6gui_mouse_poll_move."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_GET_STATE, _x_ ("Wrapper on lw6gui_mouse_get_state."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_IS_PRESSED, _x_ ("Wrapper on lw6gui_keyboard_is_pressed."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_GET_MOVE_PAD, _x_ ("Wrapper on lw6gui_keyboard_get_move_pad."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_GET_MOVE_PAD, _x_ ("Wrapper on lw6gui_joystick1_get_move_pad."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_GET_MOVE_PAD, _x_ ("Wrapper on lw6gui_joystick2_get_move_pad."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_BUTTON_LEFT, _x_ ("Wrapper on lw6gui_mouse_pop_button_left."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_BUTTON_RIGHT, _x_ ("Wrapper on lw6gui_mouse_pop_button_right."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_BUTTON_MIDDLE, _x_ ("Wrapper on lw6gui_mouse_pop_button_middle."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_SIMPLE_CLICK, _x_ ("Wrapper on lw6gui_mouse_pop_simple_click."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_DOUBLE_CLICK, _x_ ("Wrapper on lw6gui_mouse_pop_double_click."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_TRIPLE_CLICK, _x_ ("Wrapper on lw6gui_mouse_pop_triple_click."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_WHEEL_UP, _x_ ("Wrapper on lw6gui_mouse_pop_wheel_up."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_MOUSE_POP_WHEEL_DOWN, _x_ ("Wrapper on lw6gui_mouse_pop_wheel_down."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_UP, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_up."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_DOWN, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_down."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_LEFT, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_left."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_ARROW_RIGHT, _x_ ("Wrapper on lw6gui_keyboard_pop_arrow_right."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_ENTER, _x_ ("Wrapper on lw6gui_keyboard_pop_key_enter."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_ESC, _x_ ("Wrapper on lw6gui_keyboard_pop_key_esc."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_CTRL, _x_ ("Wrapper on lw6gui_keyboard_pop_key_ctrl."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_ALT, _x_ ("Wrapper on lw6gui_keyboard_pop_key_alt."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_PGUP, _x_ ("Wrapper on lw6gui_keyboard_pop_key_pgup."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_KEYBOARD_POP_KEY_PGDOWN, _x_ ("Wrapper on lw6gui_keyboard_pop_key_pgdown."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_UP, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_up."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_DOWN, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_down."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_LEFT, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_left."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_PAD_RIGHT, _x_ ("Wrapper on lw6gui_joystick1_pop_pad_right."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_A, _x_ ("Wrapper on lw6gui_joystick1_pop_button_a."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_B, _x_ ("Wrapper on lw6gui_joystick1_pop_button_b."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_C, _x_ ("Wrapper on lw6gui_joystick1_pop_button_c."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_D, _x_ ("Wrapper on lw6gui_joystick1_pop_button_d."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_E, _x_ ("Wrapper on lw6gui_joystick1_pop_button_e."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK1_POP_BUTTON_F, _x_ ("Wrapper on lw6gui_joystick1_pop_button_f."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_UP, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_up."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_DOWN, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_down."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_LEFT, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_left."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_PAD_RIGHT, _x_ ("Wrapper on lw6gui_joystick2_pop_pad_right."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_A, _x_ ("Wrapper on lw6gui_joystick2_pop_button_a."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_B, _x_ ("Wrapper on lw6gui_joystick2_pop_button_b."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_C, _x_ ("Wrapper on lw6gui_joystick2_pop_button_c."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_D, _x_ ("Wrapper on lw6gui_joystick2_pop_button_d."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_E, _x_ ("Wrapper on lw6gui_joystick2_pop_button_e."));
  POPULATE_VOID (LW6DEF_C_LW6GUI_JOYSTICK2_POP_BUTTON_F, _x_ ("Wrapper on lw6gui_joystick2_pop_button_f."));
  POPULATE_VOID (LW6DEF_C_LW6GFX_GET_BACKENDS, _x_ ("Wrapper on lw6gfx_get_backends."));
  ...
  POPULATE_VOID (LW6DEF_C_LW6DSP_GET_NB_FRAMES, _x_ ("Wrapper on lw6dsp_get_nb_frames."));
  POPULATE_VOID (LW6DEF_C_LW6DSP_GET_LAST_FRAME_RENDERING_TIME, _x_ ("Wrapper on lw6dsp_get_last_frame_rendering_time."));
  POPULATE_VOID (LW6DEF_C_LW6DSP_GET_INSTANT_FPS, _x_ ("Wrapper on lw6dsp_get_instant_fps."));
  POPULATE_VOID (LW6DEF_C_LW6DSP_GET_AVERAGE_FPS, _x_ ("Wrapper on lw6dsp_get_average_fps."));
  POPULATE_VOID (LW6DEF_C_LW6DSP_GET_VIDEO_MODE, _x_ ("Wrapper on lw6dsp_get_video_mode."));
  POPULATE_VOID (LW6DEF_C_LW6DSP_GET_FULLSCREEN_MODES, _x_ ("Wrapper on lw6dsp_get_fullscreen_modes."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_GET_ENTRIES, _x_ ("Wrapper on lw6ldr_get_entries."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_READ, _x_ ("Wrapper on lw6ldr_read."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_READ_RELATIVE, _x_ ("Wrapper on lw6ldr_read_relative."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_PRINT_EXAMPLES, _x_ ("Wrapper on lw6ldr_print_examples."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_HINTS_GET_DEFAULT, _x_ ("Wrapper on lw6ldr_hints_get_default."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_EXP_VALIDATE, _x_ ("Wrapper on lw6ldr_exp_validate."));
  POPULATE_VOID (LW6DEF_C_LW6LDR_CHAIN_ENTRY, _x_ ("Wrapper on lw6ldr_chain_entry."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_GET_LOOK, _x_ ("Wrapper on lw6map_get_look."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_PARAM_GET, _x_ ("Wrapper on lw6map_param_get."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_GET_TITLE, _x_ ("Wrapper on lw6map_get_title."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_GET_MUSIC_DIR, _x_ ("Wrapper on lw6map_get_music_dir."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_TEAM_COLOR_INDEX_TO_KEY, _x_ ("Wrapper on lw6map_team_color_index_to_key."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_TEAM_COLOR_KEY_TO_INDEX, _x_ ("Wrapper on lw6map_team_color_key_to_index."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_TEAM_COLOR_INDEX_TO_LABEL, _x_ ("Wrapper on lw6map_team_color_index_to_label."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_TEAM_COLOR_LIST, _x_ ("Wrapper on lw6map_team_color_list."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_WEAPON_INDEX_TO_KEY, _x_ ("Wrapper on lw6map_weapon_index_to_key."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_WEAPON_KEY_TO_INDEX, _x_ ("Wrapper on lw6map_weapon_key_to_index."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_WEAPON_INDEX_TO_LABEL, _x_ ("Wrapper on lw6map_weapon_index_to_label."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_WEAPON_LIST, _x_ ("Wrapper on lw6map_weapon_list."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_RULES_GET_DEFAULT, _x_ ("Wrapper on lw6map_rules_get_default."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_RULES_GET_MIN, _x_ ("Wrapper on lw6map_rules_get_min."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_RULES_GET_MAX, _x_ ("Wrapper on lw6map_rules_get_max."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_RULES_GET_INT, _x_ ("Wrapper on lw6map_rules_get_int."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_STYLE_GET_DEFAULT, _x_ ("Wrapper on lw6map_style_get_default."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_TEAMS_GET_DEFAULT, _x_ ("Wrapper on lw6map_teams_get_default."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_EXP_IS_TEAM_COLOR_ALLOWED, _x_ ("Wrapper on lw6map_exp_is_team_color_allowed."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_EXP_IS_WEAPON_ALLOWED, _x_ ("Wrapper on lw6map_exp_is_weapon_allowed."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_EXP_GET_UNLOCKED_TEAM_COLOR, _x_ ("Wrapper on lw6map_exp_get_unlocked_team_color."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_EXP_GET_UNLOCKED_WEAPON, _x_ ("Wrapper on lw6map_exp_get_unlocked_weapon."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_GET_MAX_NB_COLORS, _x_ ("Wrapper on lw6map_get_max_nb_colors."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_GET_MAX_NB_CURSORS, _x_ ("Wrapper on lw6map_get_max_nb_cursors."));
  POPULATE_VOID (LW6DEF_C_LW6MAP_GET_MAX_NB_NODES, _x_ ("Wrapper on lw6map_get_max_nb_nodes."));
  POPULATE_VOID (LW6DEF_C_LW6KER_BUILD_GAME_STRUCT, _x_ ("Wrapper on lw6ker_build_game_struct."));
  POPULATE_VOID (LW6DEF_C_LW6KER_BUILD_GAME_STATE, _x_ ("Wrapper on lw6ker_build_game_state."));
  POPULATE_VOID (LW6DEF_C_LW6KER_SYNC_GAME_STATE, _x_ ("Wrapper on lw6ker_sync_game_state."));
  POPULATE_VOID (LW6DEF_C_LW6KER_DUP_GAME_STATE, _x_ ("Wrapper on lw6ker_dup_game_state."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GAME_STRUCT_CHECKSUM, _x_ ("Wrapper on lw6ker_game_struct_checksum."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GAME_STATE_CHECKSUM, _x_ ("Wrapper on lw6ker_game_state_checksum."));
  POPULATE_VOID (LW6DEF_C_LW6KER_REGISTER_NODE, _x_ ("Wrapper on lw6ker_register_node."));
  POPULATE_VOID (LW6DEF_C_LW6KER_UNREGISTER_NODE, _x_ ("Wrapper on lw6ker_unregister_node."));
  POPULATE_VOID (LW6DEF_C_LW6KER_NODE_EXISTS, _x_ ("Wrapper on lw6ker_node_exists."));
  POPULATE_VOID (LW6DEF_C_LW6KER_ADD_CURSOR, _x_ ("Wrapper on lw6ker_add_cursor."));
  POPULATE_VOID (LW6DEF_C_LW6KER_REMOVE_CURSOR, _x_ ("Wrapper on lw6ker_remove_cursor."));
  POPULATE_VOID (LW6DEF_C_LW6KER_CURSOR_EXISTS, _x_ ("Wrapper on lw6ker_cursor_exists."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_CURSOR, _x_ ("Wrapper on lw6ker_get_cursor."));
  POPULATE_VOID (LW6DEF_C_LW6KER_SET_CURSOR, _x_ ("Wrapper on lw6ker_set_cursor."));
  POPULATE_VOID (LW6DEF_C_LW6KER_DO_ROUND, _x_ ("Wrapper on lw6ker_do_round."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_MOVES, _x_ ("Wrapper on lw6ker_get_moves."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_SPREADS, _x_ ("Wrapper on lw6ker_get_spreads."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_ROUNDS, _x_ ("Wrapper on lw6ker_get_rounds."));
  POPULATE_VOID (LW6DEF_C_LW6KER_IS_OVER, _x_ ("Wrapper on lw6ker_is_over."));
  POPULATE_VOID (LW6DEF_C_LW6KER_DID_CURSOR_WIN, _x_ ("Wrapper on lw6ker_did_cursor_win."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_NB_COLORS, _x_ ("Wrapper on lw6ker_game_state_get_nb_colors."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_NB_CURSORS, _x_ ("Wrapper on lw6ker_game_state_get_nb_cursors."));
  POPULATE_VOID (LW6DEF_C_LW6KER_GET_NB_NODES, _x_ ("Wrapper on lw6ker_game_state_get_nb_nodes."));
  POPULATE_VOID (LW6DEF_C_LW6GEN_CREATE_FROM_SEED, _x_ ("Wrapper on lw6gen_create_from_seed."));
  POPULATE_VOID (LW6DEF_C_LW6GEN_SEED_NEW, _x_ ("Wrapper on lw6gen_seed_new."));
  POPULATE_VOID (LW6DEF_C_LW6GEN_SEED_NORMALIZE, _x_ ("Wrapper on lw6gen_seed_normalize."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_BENCH, _x_ ("Wrapper on lw6pil_bench."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SEED_COMMAND_GENERATE, _x_ ("Wrapper on lw6pil_seed_command_generate."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_DUMP_COMMAND_GENERATE, _x_ ("Wrapper on lw6pil_dump_command_generate."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_POLL_DUMP, _x_ ("Wrapper on lw6pil_poll_dump."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_BUILD_PILOT, _x_ ("Wrapper on lw6pil_build_pilot."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SEND_COMMAND, _x_ ("Wrapper on lw6pil_send_command."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_LOCAL_COMMAND, _x_ ("Wrapper on lw6pil_local_command."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_COMMIT, _x_ ("Wrapper on lw6pil_commit."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_FIX_COORDS, _x_ ("Wrapper on lw6pil_coords_fix."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_FIX_COORDS_X10, _x_ ("Wrapper on lw6pil_coords_fix_x10."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_EXECUTE_COMMAND, _x_ ("Wrapper on lw6pil_execute_command."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_LOCAL_CURSORS_SET_MAIN, _x_ ("Wrapper on lw6pil_local_cursors_set_main."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_LOCAL_CURSORS_SET_MOUSE_CONTROLLED, _x_ ("Wrapper on lw6pil_local_cursors_set_mouse_controlled."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_MAKE_BACKUP, _x_ ("Wrapper on lw6pil_make_backup."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SYNC_FROM_BACKUP, _x_ ("Wrapper on lw6pil_sync_from_backup."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SYNC_FROM_REFERENCE, _x_ ("Wrapper on lw6pil_sync_from_reference."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SYNC_FROM_DRAFT, _x_ ("Wrapper on lw6pil_sync_from_draft."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_CALIBRATE, _x_ ("Wrapper on lw6pil_calibrate."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SPEED_UP, _x_ ("Wrapper on lw6pil_speed_up."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SLOW_DOWN, _x_ ("Wrapper on lw6pil_slow_down."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_ROUND_0, _x_ ("Wrapper on lw6pil_get_round_0."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_SEQ_0, _x_ ("Wrapper on lw6pil_get_seq_0."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SEQ2ROUND, _x_ ("Wrapper on lw6pil_seq2round."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_ROUND2SEQ, _x_ ("Wrapper on lw6pil_round2seq."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_NEXT_SEQ, _x_ ("Wrapper on lw6pil_get_next_seq."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_LAST_COMMIT_SEQ, _x_ ("Wrapper on lw6pil_get_last_commit_seq."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_REFERENCE_CURRENT_SEQ, _x_ ("Wrapper on lw6pil_get_reference_current_seq."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_REFERENCE_TARGET_SEQ, _x_ ("Wrapper on lw6pil_get_reference_target_seq."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_MAX_SEQ, _x_ ("Wrapper on lw6pil_get_max_seq."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_IS_OVER, _x_ ("Wrapper on lw6pil_is_over."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_DID_CURSOR_WIN, _x_ ("Wrapper on lw6pil_did_cursor_win."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_WINNER, _x_ ("Wrapper on lw6pil_get_winner."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_GET_LOOSER, _x_ ("Wrapper on lw6pil_get_looser."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SEQ_RANDOM_0, _x_ ("Wrapper on lw6pil_seq_random_0."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SUITE_INIT, _x_ ("Wrapper on lw6pil_suite_init."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SUITE_GET_SEQ_0, _x_ ("Wrapper on lw6pil_suite_get_seq_0."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SUITE_GET_NODE_ID, _x_ ("Wrapper on lw6pil_suite_get_node_id."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SUITE_GET_COMMANDS_BY_NODE_INDEX, _x_ ("Wrapper on lw6pil_suite_get_command_by_node_index, returns the list of all steps."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SUITE_GET_COMMANDS_BY_STAGE, _x_ ("Wrapper on lw6pil_suite_get_command_by_stage, returns the list of all steps."));
  POPULATE_VOID (LW6DEF_C_LW6PIL_SUITE_GET_CHECKPOINT, _x_ ("Wrapper on lw6pil_suite_get_checkpoint."));
  POPULATE_VOID (LW6DEF_C_LW6SND_GET_BACKENDS, _x_ ("Wrapper on lw6snd_get_backends."));
  ...
  POPULATE_VOID (LW6DEF_C_LW6SND_SET_FX_VOLUME, _x_ ("Wrapper on lw6snd_set_fx_volume."));
  POPULATE_VOID (LW6DEF_C_LW6SND_SET_WATER_VOLUME, _x_ ("Wrapper on lw6snd_set_water_volume."));
  POPULATE_VOID (LW6DEF_C_LW6SND_IS_MUSIC_FILE, _x_ ("Wrapper on lw6snd_is_music_file."));
  POPULATE_VOID (LW6DEF_C_LW6SND_PLAY_MUSIC_FILE, _x_ ("Wrapper on lw6snd_play_music_file."));
  POPULATE_VOID (LW6DEF_C_LW6SND_PLAY_MUSIC_RANDOM, _x_ ("Wrapper on lw6snd_play_music_random."));
  POPULATE_VOID (LW6DEF_C_LW6SND_STOP_MUSIC, _x_ ("Wrapper on lw6snd_stop_music."));
  POPULATE_VOID (LW6DEF_C_LW6SND_SET_MUSIC_VOLUME, _x_ ("Wrapper on lw6snd_set_music_volume."));
  POPULATE_VOID (LW6DEF_C_LW6CNS_CONSOLE_SUPPORT, _x_ ("Wrapper on lw6cns_console_support."));
  POPULATE_VOID (LW6DEF_C_LW6CNS_TERM_SUPPORT, _x_ ("Wrapper on lw6cns_term_support."));
  ...
  POPULATE_VOID (LW6DEF_C_LW6TSK_LOADER_NEW, _x_ ("Wrapper on lw6tsk_loader_new."));
  POPULATE_VOID (LW6DEF_C_LW6TSK_LOADER_PUSH_GEN, _x_ ("Wrapper on lw6tsk_loader_push_gen."));
  POPULATE_VOID (LW6DEF_C_LW6TSK_LOADER_PUSH_LDR, _x_ ("Wrapper on lw6tsk_loader_push_ldr."));
  POPULATE_VOID (LW6DEF_C_LW6TSK_LOADER_POP, _x_ ("Wrapper on lw6tsk_loader_pop."));
  POPULATE_VOID (LW6DEF_C_LW6TSK_LOADER_GET_STAGE, _x_ ("Wrapper on lw6tsk_loader_get_stage."));
  POPULATE_VOID (LW6DEF_C_LW6IMG_SCREENSHOT, _x_ ("Wrapper on lw6img_screenshot."));
  ...
  POPULATE_VOID (LW6DEF_C_LW6CLI_GET_BACKENDS, _x_ ("Wrapper on lw6cli_get_backends."));
  POPULATE_VOID (LW6DEF_C_LW6SRV_GET_BACKENDS, _x_ ("Wrapper on lw6srv_get_backends."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_DB_NEW, _x_ ("Wrapper on lw6p2p_db_new."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_DB_RESET, _x_ ("Wrapper on lw6p2p_db_reset."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_DB_DEFAULT_NAME, _x_ ("Wrapper on lw6p2p_db_default_name."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_NEW, _x_ ("Wrapper on lw6p2p_node_new."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_POLL, _x_ ("Wrapper on lw6p2p_node_poll."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_CLOSE, _x_ ("Wrapper on lw6p2p_node_close."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_ID, _x_ ("Wrapper on lw6p2p_node_get_id."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_ENTRIES, _x_ ("Wrapper on lw6p2p_node_get_entries."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_SERVER_START, _x_ ("Wrapper on lw6p2p_node_server_start."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_CLIENT_JOIN, _x_ ("Wrapper on lw6p2p_node_client_join."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_REFRESH_PEER, _x_ ("Wrapper on lw6p2p_node_refresh_peer."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_DISCONNECT, _x_ ("Wrapper on lw6p2p_node_disconnect."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_UPDATE_INFO, _x_ ("Wrapper on lw6p2p_node_update_info."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_CALIBRATE, _x_ ("Wrapper on lw6p2p_node_calibrate."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_LOCAL_SEQ_0, _x_ ("Wrapper on lw6p2p_node_get_local_seq_0."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_LOCAL_SEQ_LAST, _x_ ("Wrapper on lw6p2p_node_get_local_seq_last."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_SEQ_MIN, _x_ ("Wrapper on lw6p2p_node_get_seq_min."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_SEQ_MAX, _x_ ("Wrapper on lw6p2p_node_get_seq_max."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_SEQ_DRAFT, _x_ ("Wrapper on lw6p2p_node_get_seq_draft."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_SEQ_REFERENCE, _x_ ("Wrapper on lw6p2p_node_get_seq_reference."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_IS_PEER_CONNECTED, _x_ ("Wrapper on lw6p2p_node_is_peer_connected."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_IS_PEER_REGISTERED, _x_ ("Wrapper on lw6p2p_node_is_peer_registered."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_IS_SEED_NEEDED, _x_ ("Wrapper on lw6p2p_node_is_seed_needed."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_IS_DUMP_NEEDED, _x_ ("Wrapper on lw6p2p_node_is_dump_needed."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_PUT_LOCAL_MSG, _x_ ("Wrapper on lw6p2p_node_put_local_msg."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_NEXT_REFERENCE_MSG, _x_ ("Wrapper on lw6p2p_node_get_next_reference_msg."));
  POPULATE_VOID (LW6DEF_C_LW6P2P_NODE_GET_NEXT_DRAFT_MSG, _x_ ("Wrapper on lw6p2p_node_get_next_draft_msg."));
  POPULATE_VOID (LW6DEF_C_LW6BOT_GET_BACKENDS, _x_ ("Wrapper on lw6bot_get_backends."));
  POPULATE_VOID (LW6DEF_C_LW6BOT_NEW, _x_ ("Wrapper on lw6bot_new."));
  POPULATE_VOID (LW6DEF_C_LW6BOT_NEXT_MOVE, _x_ ("Wrapper on lw6bot_next_move."));
  ...
  POPULATE_VOID (LW6DEF_LDFLAGS, _x_ ("An alias for '--show-build-ldflags'."));
  POPULATE_VOID (LW6DEF_CONFIGURE_ARGS, _x_ ("An alias for '--show-build-configure-args'."));
  /*
   * team colors
   */
  ...
  POPULATE_VOID (LW6DEF_MAGENTA, _("is extremely fast but also very vulnerable"));
  POPULATE_VOID (LW6DEF_ORANGE, _("is fast, but has a very weak attack"));
  POPULATE_VOID (LW6DEF_LIGHTBLUE, _("has an extremely strong attack but is very slow"));
  POPULATE_VOID (LW6DEF_PURPLE, _("has a very good defense but a weak attack"));
  POPULATE_VOID (LW6DEF_PINK, _("has a very strong attack, but is also very vulnerable"));
  /*
   * weapons
   */
  // note: weapons need to be localized
  POPULATE_VOID (LW6DEF_BERZERK, _("super-strong attack for a limited time, crush your enemies"));
  POPULATE_VOID (LW6DEF_INVINCIBLE, _("no damage for a limited time, move untouched"));
  POPULATE_VOID (LW6DEF_ESCAPE, _("fighters placed as far as possible from cursor, magically escape from any grip"));
  POPULATE_VOID (LW6DEF_TURBO, _("move faster for a limited time"));
  POPULATE_VOID (LW6DEF_TELEPORT, _("fighters placed as close as possible to cursor"));
  POPULATE_VOID (LW6DEF_SCATTER, _("every fighters of every team scattered in random places"));
  POPULATE_VOID (LW6DEF_FIX, _("all other teams are freezed, you can move but not attack them"));
  POPULATE_VOID (LW6DEF_MIX, _("fighters exchange position, their properties being preserved"));
  POPULATE_VOID (LW6DEF_CONTROL, _("you take the control of all other teams while your cursor stays in place"));
  POPULATE_VOID (LW6DEF_PERMUTATION, _("will exchange colors, randomly, requires at least 3 teams (double edged weapon)"));
  POPULATE_VOID (LW6DEF_STEAL, _("steals some fighters to other teams"));
  POPULATE_VOID (LW6DEF_ATOMIC, _("nuclear explosion, all fighters arround your cursor are about to die"));
  POPULATE_VOID (LW6DEF_REVERSE, _("fighters continue to move normally, but attacks are done in reverse mode, backwards"));
  POPULATE_VOID (LW6DEF_CRAZY, _("all your opponents go crazy for some time, acting with no logic"));
  POPULATE_VOID (LW6DEF_REWIND, _("make the battlefield be like it was a few seconds ago"));
  POPULATE_VOID (LW6DEF_ATTRACT, _("all fighters from all teams are packed near your cursor"));
  POPULATE_VOID (LW6DEF_SHRINK, _("reduces the number of fighters on the map"));
  POPULATE_VOID (LW6DEF_KAMIKAZE, _("you die along with the strongest team on the battlefield, requires at least 3 teams"));
  POPULATE_VOID (LW6DEF_DISAPPEAR, _("you disappear for some time from the battlefield, to reappear later, somewhere else"));
  POPULATE_VOID (LW6DEF_PLAGUE, _("general disease, all fighters mysteriously loose health"));
  ret = 1;
  return ret;
}
