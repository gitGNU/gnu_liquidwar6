...
int
_mod_csound_path_init (lw6sys_context_t * sys_context, _mod_csound_context_t * csound_context, int argc, const char *argv[])
{
...
void
_mod_csound_path_quit (lw6sys_context_t * sys_context, _mod_csound_context_t * csound_context)
{
