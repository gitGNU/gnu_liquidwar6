...
/* mod-udp-setup.c */
extern _mod_udp_context_t *_mod_udp_init (int argc, const char *argv[], lw6cnx_properties_t * properties);
...
extern void _mod_udp_close (_mod_udp_context_t * udp_context, lw6cnx_connection_t * connection);
extern int _mod_udp_timeout_ok (_mod_udp_context_t * udp_context, int64_t origin_timestamp, int broadcast);
...
extern int _mod_udp_can_send (_mod_udp_context_t * udp_context, lw6cnx_connection_t * connection);
extern void _mod_udp_poll (_mod_udp_context_t * udp_context, lw6cnx_connection_t * connection);

/* mod-udp-info.c */
extern char *_mod_udp_repr (_mod_udp_context_t * udp_context, lw6cnx_connection_t * connection);

/* mod-udp-oob.c */
extern int _mod_udp_process_oob (_mod_udp_context_t * udp_context, lw6nod_info_t * node_info, lw6cli_oob_data_t * oob_data);
extern int _mod_udp_oob_should_continue (_mod_udp_context_t * udp_context, lw6cli_oob_data_t * oob_data, int broadcast);
