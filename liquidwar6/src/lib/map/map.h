...
#define LW6MAP_RULES_DEFAULT_RESPAWN_RANDOM_PLACE 1
#define LW6MAP_RULES_MIN_RESPAWN_RANDOM_PLACE 0
#define LW6MAP_RULES_MAX_RESPAWN_RANDOM_PLACE 1
...
#define LW6MAP_RULES_DEFAULT_START_POSITION_MODE 0
#define LW6MAP_RULES_MIN_START_POSITION_MODE 0
#define LW6MAP_RULES_MAX_START_POSITION_MODE 2

#define LW6MAP_RULES_DEFAULT_COLOR_CONFLICT_MODE 1
...
#define LW6MAP_RULES_MAX_FRAGS_MODE 2
