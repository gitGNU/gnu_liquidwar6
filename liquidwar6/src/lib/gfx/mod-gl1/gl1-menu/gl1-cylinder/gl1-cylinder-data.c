  ...
  if (!strcmp (element, "int"))
    {
      ...
      lw6cfg_read_xml_int (key, value, "popup-max-width",
			   &const_data->popup_max_width);
      lw6cfg_read_xml_int (key, value, "popup-max-height",
			   &const_data->popup_max_height);
      lw6cfg_read_xml_int (key, value, "popup-border-size",
			   &const_data->popup_border_size);
      lw6cfg_read_xml_int (key, value, "popup-margin-size",
			   &const_data->popup_margin_size);
      lw6cfg_read_xml_int (key, value, "popup-reformat-width",
  ...
  if (!strcmp (element, "float"))
    {
      ...
      lw6cfg_read_xml_float (key, value, "cyl-height",
			     &const_data->cyl_height);
      lw6cfg_read_xml_float (key, value, "oscil-range1",
			     &const_data->oscil_range1);
      lw6cfg_read_xml_float (key, value, "texture-offset",
			     &const_data->texture_offset);
      ...
      lw6cfg_read_xml_float (key, value, "progress-offset",
			     &const_data->progress_offset);
      lw6cfg_read_xml_float (key, value, "progress-radius",
			     &const_data->progress_radius);
      lw6cfg_read_xml_float (key, value, "progress-cyl-height",
			     &const_data->progress_cyl_height);
      lw6cfg_read_xml_float (key, value, "esc-offset",
			     &const_data->esc_offset);
      lw6cfg_read_xml_float (key, value, "esc-radius",
			     &const_data->esc_radius);
      lw6cfg_read_xml_float (key, value, "esc-cyl-height",
			     &const_data->esc_cyl_height);
      lw6cfg_read_xml_float (key, value, "esc-cyl-height-offset",
      ...
      lw6cfg_read_xml_float (key, value, "popup-alpha-bg",
			     &const_data->popup_alpha_bg);
      lw6cfg_read_xml_float (key, value, "popup-relative-size",
			     &const_data->popup_relative_size);
    }
}
	       ...
	       _mod_gl1_menu_cylinder_context_t * cylinder_context)
{
  memset (&cylinder_context->const_data, 0,
	  sizeof (_mod_gl1_menu_cylinder_const_data_t));
}
 ...
 */
int
_mod_gl1_menu_cylinder_load_data (mod_gl1_utils_context_t * utils_context,
...
int
mod_gl1_menu_load_data (mod_gl1_utils_context_t * utils_context,
			void *cylinder_context)
{
  return _mod_gl1_menu_cylinder_load_data (utils_context,
					   (_mod_gl1_menu_cylinder_context_t
					    *) cylinder_context);
}

void
_mod_gl1_menu_cylinder_unload_data (mod_gl1_utils_context_t * utils_context,
				    _mod_gl1_menu_cylinder_context_t *
				    cylinder_context)
{
...
void
mod_gl1_menu_unload_data (mod_gl1_utils_context_t * utils_context,
			  void *cylinder_context)
{
  _mod_gl1_menu_cylinder_unload_data (utils_context,
				      (_mod_gl1_menu_cylinder_context_t *)
				      cylinder_context);
}
