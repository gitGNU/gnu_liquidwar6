...
void
mod_gl1_menu_display_menu (lw6sys_context_t *sys_context, mod_gl1_utils_context_t * utils_context, mod_gl1_menu_backend_t * backend, const lw6gui_look_t * look,
			   lw6gui_menu_t * menu)
{
...
void
mod_gl1_menu_display_progress (lw6sys_context_t *sys_context, mod_gl1_utils_context_t * utils_context, mod_gl1_menu_backend_t * backend, const lw6gui_look_t * look,
			       float progress)
{
...
void
mod_gl1_menu_display_meta (lw6sys_context_t *sys_context, mod_gl1_utils_context_t * utils_context, mod_gl1_menu_backend_t * backend, const lw6gui_look_t * look,
			   lw6gui_menu_t * menu)
{
