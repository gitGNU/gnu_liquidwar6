...
static void
_set_map_rules (mod_gl1_utils_context_t * utils_context,
...
static void
_set_fighters_rules (mod_gl1_utils_context_t * utils_context,
		     _mod_gl1_view_flat_context_t * flat_context)
{
	  ...
	  for (x = flat_context->viewport.map_visible.x1;
		   ...
		   x_polarity, y_polarity))
		{
		  ...
		  if (last_bitmap == bitmap)
		    {
		      mod_gl1_utils_bitmap_bind_no_gen (utils_context,
							bitmap);
		    }
		  else
		    {
				    ...
				    lw6map_level_t * level)
{
  if (utils_context && flat_context && level && level->texture.data)
    {
      _mod_gl1_view_flat_game_context_update_map (utils_context,
						  flat_context,
						  &
						  (flat_context->
      ...
      else
	{
      ...
      _mod_gl1_view_flat_viewport_update_preview (utils_context,
  ...
  if (utils_context && flat_context && game_state)
    {
      ...
      _mod_gl1_view_flat_game_context_update (utils_context,
					      flat_context,
      ...
      else
	{
      ...
      _mod_gl1_view_flat_viewport_update (utils_context,
				    ...
				    lw6pil_local_cursors_t * local_cursors)
{
  if (utils_context && flat_context && game_state)
    {
      _mod_gl1_view_flat_cursors_context_update (utils_context,
						 &flat_context->
						 cursors_context,
						 &flat_context->const_data,
						 look, game_state);
