  ...
  if (mod_gl1_context)
    {
      ...
      lw6sys_log (sys_context, LW6SYS_LOG_DEBUG, _x_ ("display mask=%d"),
		  mask);
      if (mask & LW6GUI_DISPLAY_SPLASH)
	{
	  lw6sys_log (sys_context, LW6SYS_LOG_DEBUG,
		      _x_ ("display step=splash"));
