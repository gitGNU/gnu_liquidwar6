...
extern mod_gl1_hud_backend_t
  * mod_gl1_hud_floating_create_backend (mod_gl1_utils_context_t *
					 utils_context);
 ...
 * In setup.c
 */
extern void *mod_gl1_hud_floating_init (mod_gl1_utils_context_t *
					utils_context);
extern void mod_gl1_hud_floating_quit (mod_gl1_utils_context_t *
