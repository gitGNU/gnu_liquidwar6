 ...
 * In bitmap.c
 */
extern mod_gl1_utils_bitmap_t *mod_gl1_utils_bitmap_new (mod_gl1_utils_context_t * utils_context, int width, int height, const char *desc);
extern mod_gl1_utils_bitmap_t *mod_gl1_utils_bitmap_load (mod_gl1_utils_context_t * utils_context, const char *filename);
extern mod_gl1_utils_bitmap_t *mod_gl1_utils_surface2bitmap (mod_gl1_utils_context_t * utils_context, SDL_Surface * surface, const char *desc);
extern void mod_gl1_utils_bitmap_free (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
...
extern int mod_gl1_utils_bitmap_set_wrap (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap, GLint wrap);
extern int mod_gl1_utils_bitmap_set_filter (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap, GLint filter);
extern int mod_gl1_utils_bitmap_set_texture_coords (mod_gl1_utils_context_t *
						    utils_context, mod_gl1_utils_bitmap_t * bitmap, float s1, float t1, float s2, float t2);
extern void mod_gl1_utils_bitmap_clear_texture (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern void mod_gl1_utils_bitmap_clear_texture_now (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern int mod_gl1_utils_bitmap_refresh (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern int mod_gl1_utils_bitmap_refresh_force (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern void mod_gl1_utils_bitmap_bind_no_gen (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern int mod_gl1_utils_bitmap_bind (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern int mod_gl1_utils_bitmap_display (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap, float x1, float y1, float x2, float y2);
extern int mod_gl1_utils_bitmap_update_texture (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
...
extern int mod_gl1_utils_bitmap_array_update (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_array_t * bitmap_array, GLint wrap, GLint filter);
extern void mod_gl1_utils_bitmap_array_clear (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_array_t * bitmap_array);
extern int mod_gl1_utils_bitmap_array_set (mod_gl1_utils_bitmap_array_t * bitmap_array, int i, mod_gl1_utils_bitmap_t * bitmap);
extern mod_gl1_utils_bitmap_t *mod_gl1_utils_bitmap_array_get (mod_gl1_utils_bitmap_array_t * bitmap_array, int i);
...
extern int mod_gl1_utils_bitmap_hash_register (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern int mod_gl1_utils_bitmap_hash_unregister (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_bitmap_t * bitmap);
extern int mod_gl1_utils_bitmap_hash_refresh (mod_gl1_utils_context_t * utils_context);
extern int mod_gl1_utils_bitmap_hash_dump2disk (mod_gl1_utils_context_t * utils_context, int force);

/* gl1-utils-cache.c */
int mod_gl1_utils_cache_update (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look);

/*
 * In capture.c
 */
extern SDL_Surface *mod_gl1_utils_capture2surface (mod_gl1_utils_context_t * utils_context);
extern int mod_gl1_utils_capture2disk (mod_gl1_utils_context_t * utils_context);

/*
 * In color.c
 */
extern SDL_Color mod_gl1_utils_color_8_to_sdl (lw6sys_color_8_t color_8);
extern SDL_Color mod_gl1_utils_color_f_to_sdl (const lw6sys_color_f_t * color_f);
extern void mod_gl1_utils_update_team_color_map (mod_gl1_utils_team_color_map_t * team_color_map, const lw6map_style_t * map_style);
extern int mod_gl1_utils_team_color_map_is_same (const
						 mod_gl1_utils_team_color_map_t * team_color_map_a, const mod_gl1_utils_team_color_map_t * team_color_map_b);
extern void mod_gl1_utils_force_color32_alpha (Uint32 * color, float alpha);
extern Uint32 mod_gl1_utils_get_shaded_color_for_fighter_f (mod_gl1_utils_context_t * utils_context, int team_id, float health);
...
extern SDL_Surface *mod_gl1_utils_load_image (mod_gl1_utils_context_t * utils_context, const char *filename);
extern void mod_gl1_utils_unload_image (mod_gl1_utils_context_t * utils_context, SDL_Surface * image);
extern int mod_gl1_utils_load_fonts (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_unload_fonts (mod_gl1_utils_context_t * utils_context);
extern int mod_gl1_utils_load_data (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_unload_data (mod_gl1_utils_context_t * utils_context);

/*
 * In debug.c
 */
extern void mod_gl1_utils_display_zones (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const lw6ker_game_struct_t * game_struct);
extern void mod_gl1_utils_display_gradient (mod_gl1_utils_context_t *
					    utils_context, const lw6gui_look_t * look, const lw6ker_game_state_t * game_state, int team_id, int layer_id);

/*
 * In display.c
 */
extern void mod_gl1_utils_display_quad_begin (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_display_quad_end (mod_gl1_utils_context_t * utils_context);
 ...
 * In draw.c
 */
extern void mod_gl1_utils_draw_rectfill (SDL_Surface * surface, int x1, int y1, int x2, int y2, Uint32 color);
extern void mod_gl1_utils_draw_set_alpha_for_color (SDL_Surface * surface, float alpha, Uint32 color);
 ...
 * In font.c
 */
extern int mod_gl1_utils_get_system_text_width (mod_gl1_utils_context_t * utils_context, const char *text);
extern int mod_gl1_utils_get_system_text_height (mod_gl1_utils_context_t * utils_context, const char *text);
extern mod_gl1_utils_bitmap_t
...
extern SDL_Surface *mod_gl1_utils_blended_text_surface (mod_gl1_utils_context_t * context, TTF_Font * font, SDL_Color color, const char *text);
extern void mod_gl1_utils_draw_system_text (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char *text, int x, int y);
extern void mod_gl1_utils_draw_system_text_top_left (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char **text_list);
extern void mod_gl1_utils_draw_system_text_top_right (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char **text_list);
extern void mod_gl1_utils_draw_system_text_bottom_left (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char **text_list);
extern void mod_gl1_utils_draw_system_text_bottom_right (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char **text_list);
...
extern void mod_gl1_utils_icon_unset (mod_gl1_utils_context_t * utils_context);

/*
 * In info.c
 */
extern void mod_gl1_utils_display_log (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char **log_list);
extern void mod_gl1_utils_display_fps (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, float fps);
extern void mod_gl1_utils_display_mps (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, float mps, int target_mps);
extern void mod_gl1_utils_display_url (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look, const char *url);

/*
 * In joystick.c
 */
extern int mod_gl1_utils_joystick_init (mod_gl1_utils_joysticks_info_t * joysticks_info);
extern void mod_gl1_utils_joystick_quit (mod_gl1_utils_joysticks_info_t * joysticks_info);

/*
 * In light.c
 */
extern void mod_gl1_utils_main_light (mod_gl1_utils_context_t * utils_context);
...
extern void mod_gl1_utils_clear_menucache (mod_gl1_utils_context_t * utils_context);

/*
 * In mode.c
 */
extern int mod_gl1_utils_set_video_mode (mod_gl1_utils_context_t * utils_context, lw6gui_video_mode_t * video_mode);
extern int mod_gl1_utils_resize_video_mode (mod_gl1_utils_context_t * utils_context, lw6gui_video_mode_t * video_mode);
extern int mod_gl1_utils_get_video_mode (mod_gl1_utils_context_t * utils_context, lw6gui_video_mode_t * video_mode);
extern int mod_gl1_utils_sync_viewport (mod_gl1_utils_context_t * utils_context);
extern int mod_gl1_utils_sync_mode (mod_gl1_utils_context_t * utils_context, int force);
extern int mod_gl1_utils_set_resize_callback (mod_gl1_utils_context_t * utils_context, lw6gui_resize_callback_func_t resize_callback);
extern void mod_gl1_utils_call_resize_callback (mod_gl1_utils_context_t * utils_context);

/*
 * In mouse.c
 */
extern void mod_gl1_utils_show_mouse (mod_gl1_utils_context_t * utils_context, int state, int force);

/*
 * In path.c
 */
extern int mod_gl1_utils_path_init (mod_gl1_utils_context_t * utils_context, int argc, const char *argv[]);
extern int mod_gl1_utils_path_update (mod_gl1_utils_context_t * utils_context);
...
extern void mod_gl1_utils_putpixel (SDL_Surface * surface, int x, int y, Uint32 pixel);
static inline void
 ...
 * In render.c
 */
extern void mod_gl1_utils_prepare_buffer (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look);
extern void mod_gl1_utils_swap_buffers (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_set_render_mode_2d (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_set_render_mode_2d_blend (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_set_render_mode_3d_map (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_set_render_mode_3d_menu (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_set_render_mode_3d_select (mod_gl1_utils_context_t * utils_context, int x, int y);
extern void mod_gl1_utils_set_render_mode_3d_feedback (mod_gl1_utils_context_t * utils_context);

/*
 * In resolution.c
 */
extern int mod_gl1_utils_get_fullscreen_modes (mod_gl1_utils_context_t * utils_context, lw6gui_fullscreen_modes_t * modes);
...
extern int mod_gl1_utils_shaded_text_update (mod_gl1_utils_context_t *
					     utils_context, mod_gl1_utils_shaded_text_t * shaded_text, const char *text, const lw6map_color_couple_t * color);
...
extern void mod_gl1_utils_shaded_text_free (mod_gl1_utils_context_t * utils_context, mod_gl1_utils_shaded_text_t * shaded_text);

/*
 * In smoothers.c
 */
extern void mod_gl1_utils_smoothers_init (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_smoothers_reset_drawable (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_smoothers_update (mod_gl1_utils_context_t * utils_context);

/*
 * In surface.c
 */
extern SDL_Surface *mod_gl1_utils_create_surface (mod_gl1_utils_context_t * utils_context, int w, int h);
extern void mod_gl1_utils_delete_surface (mod_gl1_utils_context_t * utils_context, SDL_Surface * surface);
extern void mod_gl1_utils_clear_surface_with_color (SDL_Surface * surface, SDL_Color color);
extern void mod_gl1_utils_clear_surface (SDL_Surface * surface);
extern SDL_Surface *mod_gl1_utils_map2surface_xywh (mod_gl1_utils_context_t * utils_context, const lw6map_level_t * level, int x, int y, int w, int h);
extern SDL_Surface *mod_gl1_utils_map2surface_wh (mod_gl1_utils_context_t * utils_context, const lw6map_level_t * level, int w, int h);
extern SDL_Surface *mod_gl1_utils_map2surface (mod_gl1_utils_context_t * utils_context, const lw6map_level_t * level);

/*
 * In texture.c
 */
extern float mod_gl1_utils_texture_scale (int size);
extern GLuint mod_gl1_utils_surface2texture_xywh (mod_gl1_utils_context_t * utils_context, SDL_Surface * surface, int x, int y, int w, int h, int mipmap);
extern GLuint mod_gl1_utils_surface2texture_wh (mod_gl1_utils_context_t * utils_context, SDL_Surface * surface, int w, int h, int mipmap);
extern GLuint mod_gl1_utils_surface2texture (mod_gl1_utils_context_t * utils_context, SDL_Surface * surface, int mipmap);
extern GLuint mod_gl1_utils_map2texture_xywh (mod_gl1_utils_context_t * utils_context, const lw6map_level_t * level, int x, int y, int w, int h);
extern GLuint mod_gl1_utils_map2texture_wh (mod_gl1_utils_context_t * utils_context, const lw6map_level_t * level, int w, int h);
extern GLuint mod_gl1_utils_map2texture (mod_gl1_utils_context_t * utils_context, const lw6map_level_t * level);
extern void mod_gl1_utils_delete_texture (mod_gl1_utils_context_t * utils_context, GLuint texture);
extern void mod_gl1_utils_schedule_delete_texture (mod_gl1_utils_context_t * utils_context, GLuint texture);
extern void mod_gl1_utils_delete_scheduled_textures (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_texture_update (mod_gl1_utils_context_t * utils_context, GLuint texture, SDL_Surface * surface);

/*
 * In texture1x1.c
 */
extern mod_gl1_utils_bitmap_t *mod_gl1_utils_texture_1x1_color2bitmap (mod_gl1_utils_context_t * utils_context, lw6sys_color_8_t color_8);
extern int mod_gl1_utils_texture_1x1_update (mod_gl1_utils_context_t * utils_context, const lw6gui_look_t * look);
extern void mod_gl1_utils_texture_1x1_clear (mod_gl1_utils_context_t * utils_context);

/*
 * In timer.c
 */
extern int64_t mod_gl1_utils_timer_get_bitmap_refresh (mod_gl1_utils_context_t * utils_context);
extern void mod_gl1_utils_timer_set_bitmap_refresh (mod_gl1_utils_context_t * utils_context);

/*
 * In viewport.c
 */
extern void mod_gl1_utils_viewport_drawable_max (mod_gl1_utils_context_t * utils_context);

/*
 * In zones.c
 */
extern SDL_Surface *mod_gl1_utils_create_zones_surface (mod_gl1_utils_context_t * utils_context, const lw6ker_game_struct_t * map_struct);
