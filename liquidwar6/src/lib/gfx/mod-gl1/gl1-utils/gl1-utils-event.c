...
key_down (lw6gui_keyboard_t * keyboard, SDL_Event * event,
	  mod_gl1_utils_const_data_t * const_data, int64_t timestamp)
{
  int sym = 0;
...
static int
joystick_index (SDL_Event * event, mod_gl1_utils_const_data_t * const_data)
{
  int ret = -1;
...
joystick_button_index (SDL_Event * event,
		       mod_gl1_utils_const_data_t * const_data, int i)
{
  int ret = -1;
 ...
 */
lw6gui_input_t *
mod_gl1_utils_pump_events (mod_gl1_utils_context_t * utils_context)
{
  lw6gui_video_mode_t video_mode;
  SDL_Event event;
  int64_t timestamp;
  lw6gui_input_t *input = &(utils_context->input);
  mod_gl1_utils_const_data_t *const_data = &(utils_context->const_data);
  int i, b;
