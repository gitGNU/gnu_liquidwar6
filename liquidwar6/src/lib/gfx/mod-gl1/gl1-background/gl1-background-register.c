...
mod_gl1_background_create_backend (mod_gl1_utils_context_t * utils_context,
				   char *name)
{
  mod_gl1_background_backend_t *(*init_func) (mod_gl1_utils_context_t *
					      utils_context) = NULL;
...
void
mod_gl1_background_destroy_backend (mod_gl1_utils_context_t * utils_context,
