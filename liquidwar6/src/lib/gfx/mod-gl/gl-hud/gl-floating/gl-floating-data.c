...
#define CONST_FILE "hud/floating/gl-floating-const.xml"
...
read_callback (void *callback_data, char *element, char *key, char *value)
{
  ...
  const_data = (_mod_gl_hud_floating_const_data_t *) callback_data;
	       ...
	       _mod_gl_hud_floating_context_t * floating_context)
{
  memset (&floating_context->const_data, 0,
	  sizeof (_mod_gl_hud_floating_const_data_t));
}
 ...
 */
int
_mod_gl_hud_floating_load_data (mod_gl_utils_context_t * utils_context,
...
void
_mod_gl_hud_floating_unload_data (mod_gl_utils_context_t * utils_context,
				  _mod_gl_hud_floating_context_t *
				  floating_context)
{
