...
_mod_gl_hud_floating_init (mod_gl_utils_context_t * utils_context)
{
  ...
  floating_context =
    (_mod_gl_hud_floating_context_t *)
    LW6SYS_MALLOC (sizeof (_mod_gl_hud_floating_context_t));
  if (!floating_context)
    {
      /*
  ...
  memset (floating_context, 0, sizeof (_mod_gl_hud_floating_context_t));


  if (!_mod_gl_hud_floating_load_data (utils_context, floating_context))
    {
  ...
  if (floating_context
      && !_mod_gl_hud_floating_context_init (utils_context, floating_context))
    {
      LW6SYS_FREE (floating_context);
      floating_context = NULL;
    }
...
void *
mod_gl_hud_floating_init (mod_gl_utils_context_t * utils_context)
{
  return (void *) _mod_gl_hud_floating_init (utils_context);
}
...
void
mod_gl_hud_floating_quit (mod_gl_utils_context_t * utils_context,
			  void *floating_context)
{
  _mod_gl_hud_floating_quit (utils_context,
			     (_mod_gl_hud_floating_context_t *)
			     floating_context);
}
