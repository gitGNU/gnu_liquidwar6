...
mod_gl_view_create_backend (mod_gl_utils_context_t * utils_context,
			    char *name)
{
  mod_gl_view_backend_t *(*init_func) (mod_gl_utils_context_t *
				       utils_context) = NULL;
  mod_gl_view_backend_t *backend = NULL;
...
void
mod_gl_view_destroy_backend (mod_gl_utils_context_t * utils_context,
