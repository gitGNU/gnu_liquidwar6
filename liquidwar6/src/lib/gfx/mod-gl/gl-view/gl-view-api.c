...
_warning (const char *func_name)
{
  lw6sys_log (LW6SYS_LOG_WARNING,
	      _x_ ("view backend function \"%s\" is not defined"));
}
...
void
mod_gl_view_display_map (mod_gl_utils_context_t * utils_context,
			 mod_gl_view_backend_t * backend,
			 lw6gui_look_t * look,
...
void
mod_gl_view_display_fighters (mod_gl_utils_context_t * utils_context,
			      mod_gl_view_backend_t * backend,
			      lw6gui_look_t * look,
			      lw6ker_game_state_t * game_state,
			      lw6pil_local_cursors_t * local_cursors)
...
void
mod_gl_view_display_cursors (mod_gl_utils_context_t * utils_context,
			     mod_gl_view_backend_t * backend,
			     lw6gui_look_t * look,
			     lw6ker_game_state_t * game_state,
			     lw6pil_local_cursors_t * local_cursors)
