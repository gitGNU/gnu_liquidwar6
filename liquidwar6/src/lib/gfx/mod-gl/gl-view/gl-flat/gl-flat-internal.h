...
typedef struct _mod_gl_view_flat_game_context_map_s
{
  ...
  mod_gl_utils_bitmap_array_t map_bitmap_array;
}
...
typedef struct _mod_gl_view_flat_game_context_armies_s
{
  ...
  mod_gl_utils_bitmap_array_t armies_bitmap_array;
}
...
typedef struct _mod_gl_view_flat_cursor_context_s
{
  u_int16_t cursor_id;
  char letter;
  int team_color;
 ...
 * In cursorcontext.c
 */
extern int _mod_gl_view_flat_cursor_context_init (mod_gl_utils_context_t *
						  utils_context,
						  _mod_gl_view_flat_cursor_context_t
						  * cursor_context,
						  _mod_gl_view_flat_const_data_t
...
extern int _mod_gl_view_flat_cursor_context_clear (mod_gl_utils_context_t *
						   ...
						   _mod_gl_view_flat_cursor_context_t
						   * cursor_context);
extern int _mod_gl_view_flat_cursors_context_init (mod_gl_utils_context_t *
						   utils_context,
						   _mod_gl_view_flat_cursors_context_t
						   * cursors_context,
						   _mod_gl_view_flat_const_data_t
						   * const_data,
						   ...
						   lw6ker_game_state_t *
						   game_state);
extern int _mod_gl_view_flat_cursors_context_update (mod_gl_utils_context_t *
						     utils_context,
						     _mod_gl_view_flat_cursors_context_t
						     * cursors_context,
						     _mod_gl_view_flat_const_data_t
						     * const_data,
						     ...
						     lw6ker_game_state_t *
						     game_state);
extern int _mod_gl_view_flat_cursors_context_clear (mod_gl_utils_context_t *
						    utils_context,
						    _mod_gl_view_flat_cursors_context_t
						    * cursors_context);
...
extern void _mod_gl_view_flat_display_preview (mod_gl_utils_context_t *
					       ...
					       lw6gui_look_t * look,
					       lw6map_level_t * level);
extern void _mod_gl_view_flat_display_map (mod_gl_utils_context_t *
					   utils_context,
					   _mod_gl_view_flat_context_t *
					   flat_context,
					   lw6gui_look_t * look,
					   ...
					   local_cursors);
extern void _mod_gl_view_flat_display_fighters (mod_gl_utils_context_t *
						utils_context,
						_mod_gl_view_flat_context_t *
						flat_context,
						lw6gui_look_t * look,
						...
						lw6pil_local_cursors_t *
						local_cursors);
extern void _mod_gl_view_flat_display_cursors (mod_gl_utils_context_t *
					       utils_context,
					       _mod_gl_view_flat_context_t *
					       flat_context,
					       lw6gui_look_t * look,
 ...
 * in viewport.c
 */
extern void _mod_gl_view_flat_viewport_update_preview (mod_gl_utils_context_t
						       * utils_context,
						       _mod_gl_view_flat_context_t
						       * flat_context,
						       lw6gui_look_t * look,
						       lw6map_level_t *
						       level);
extern void _mod_gl_view_flat_viewport_update (mod_gl_utils_context_t *
					       utils_context,
					       _mod_gl_view_flat_context_t *
					       flat_context,
					       lw6gui_look_t * look,
