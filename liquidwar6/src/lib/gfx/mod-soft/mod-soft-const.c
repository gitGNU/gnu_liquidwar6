...
_read_callback (lw6sys_context_t * sys_context, void *callback_data, const char *element, const char *key, const char *value)
{
  ...
  const_data = (_mod_soft_const_data_t *) callback_data;
 ...
 */
int
_mod_soft_load_consts (lw6sys_context_t * sys_context, _mod_soft_context_t * context)
{
  int ret = 0;
 ...
 */
void
_mod_soft_unload_consts (lw6sys_context_t * sys_context, _mod_soft_context_t * context)
{
  memset (&context->const_data, 0, sizeof (_mod_soft_const_data_t));
}
