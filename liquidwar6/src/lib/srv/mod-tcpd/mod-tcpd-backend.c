 ...
 *
 * Defined to tell mod_tcpd is compatible with GNU General Public License
...
mod_tcpd_get_pedigree (lw6sys_context_t * sys_context)
{
  ...
  if (module_pedigree)
    {
      ...
      module_pedigree->readme = _x_ ("Basic TCP/IP server, the most reliable way to communicate.");
 ...
 */
lw6srv_backend_t *
mod_tcpd_create_backend (lw6sys_context_t * sys_context)
{
