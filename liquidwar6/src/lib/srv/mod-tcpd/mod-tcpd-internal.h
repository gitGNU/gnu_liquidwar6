...
/* mod-tcpd-data.c */
extern int _mod_tcpd_load_data (_mod_tcpd_data_t * tcpd_data, const char *data_dir);
extern void _mod_tcpd_unload_data (_mod_tcpd_data_t * tcpd_data);

/* mod-tcpd-setup.c */
extern _mod_tcpd_context_t *_mod_tcpd_init (int argc, const char *argv[], lw6cnx_properties_t * properties, lw6srv_listener_t * listener);
...
extern int _mod_tcpd_feed_with_tcp (_mod_tcpd_context_t * tcpd_context, lw6cnx_connection_t * connection, lw6srv_tcp_accepter_t * tcp_accepter);
extern int _mod_tcpd_feed_with_udp (_mod_tcpd_context_t * tcpd_context, lw6cnx_connection_t * connection, lw6srv_udp_buffer_t * udp_buffer);
...
extern void _mod_tcpd_close (_mod_tcpd_context_t * tcpd_context, lw6cnx_connection_t * connection);
extern int _mod_tcpd_timeout_ok (_mod_tcpd_context_t * tcpd_context, int64_t origin_timestamp);
...
extern int _mod_tcpd_can_send (_mod_tcpd_context_t * tcpd_context, lw6cnx_connection_t * connection);
extern void _mod_tcpd_poll (_mod_tcpd_context_t * tcpd_context, lw6cnx_connection_t * connection);

/* mod-tcpd-info.c */
extern char *_mod_tcpd_repr (_mod_tcpd_context_t * tcpd_context, lw6cnx_connection_t * connection);

/* mod-tcpd-oob.c */
extern int _mod_tcpd_process_oob (_mod_tcpd_context_t * tcpd_context, lw6nod_info_t * node_info, lw6srv_oob_data_t * oob_data);
extern int _mod_tcpd_oob_should_continue (_mod_tcpd_context_t * tcpd_context, lw6srv_oob_data_t * oob_data);
