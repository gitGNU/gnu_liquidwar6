...
extern int lw6mat_fmat2_inv (lw6mat_fmat2_t * fmat2_dst, const lw6mat_fmat2_t * fmat2_src);
...
extern int lw6mat_fmat3_inv (lw6mat_fmat3_t * fmat3_dst, const lw6mat_fmat3_t * fmat3_src);
...
extern int lw6mat_fmat4_inv (lw6mat_fmat4_t * fmat4_dst, const lw6mat_fmat4_t * fmat4_src);
...
extern int lw6mat_dmat2_inv (lw6mat_dmat2_t * dmat2_dst, const lw6mat_dmat2_t * dmat2_src);
...
extern int lw6mat_dmat3_inv (lw6mat_dmat3_t * dmat3_dst, const lw6mat_dmat3_t * dmat3_src);
...
extern int lw6mat_dmat4_inv (lw6mat_dmat4_t * dmat4_dst, const lw6mat_dmat4_t * dmat4_src);
