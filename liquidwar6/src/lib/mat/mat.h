...
extern int lw6mat_fvec2_norm (lw6sys_context_t * sys_context, lw6mat_fvec2_t * fvec2);
...
extern int lw6mat_fvec3_norm (lw6sys_context_t * sys_context, lw6mat_fvec3_t * fvec3);
...
extern int lw6mat_fvec4_norm (lw6sys_context_t * sys_context, lw6mat_fvec4_t * fvec4);
...
extern int lw6mat_ivec2_norm (lw6sys_context_t * sys_context, lw6mat_ivec2_t * ivec2);
...
extern int lw6mat_ivec3_norm (lw6sys_context_t * sys_context, lw6mat_ivec3_t * ivec3);
...
extern int lw6mat_ivec4_norm (lw6sys_context_t * sys_context, lw6mat_ivec4_t * ivec4);
...
extern int lw6mat_dvec2_norm (lw6sys_context_t * sys_context, lw6mat_dvec2_t * dvec2);
...
extern int lw6mat_dvec3_norm (lw6sys_context_t * sys_context, lw6mat_dvec3_t * dvec3);
...
extern int lw6mat_dvec4_norm (lw6sys_context_t * sys_context, lw6mat_dvec4_t * dvec4);
...
extern int lw6mat_xvec2_norm (lw6sys_context_t * sys_context, lw6mat_xvec2_t * xvec2);
...
extern int lw6mat_xvec3_norm (lw6sys_context_t * sys_context, lw6mat_xvec3_t * xvec3);
...
extern int lw6mat_xvec4_norm (lw6sys_context_t * sys_context, lw6mat_xvec4_t * xvec4);
...
extern void lw6mat_dmat3_scale (lw6mat_dmat3_t * dmat3, double d);
...
extern void lw6mat_dmat4_scale (lw6mat_dmat4_t * dmat4, double d);
