	  ...
	  if (c_server_id_int > 0)
	    {
	      ...
	      c_ret = lw6pil_seed_command_generate (c_pilot, c_server_id_int, c_seq);
	      if (c_ret)
		{
  ...
  if (c_pilot)
      ...
      if (c_server_id_str)
	{
	  ...
	  if (c_server_id_int > 0)
	    {
	      c_seq = scm_to_long_long (seq);
	      c_ret = lw6pil_dump_command_generate (c_pilot, c_server_id_int, c_seq);
	      if (c_ret)
		{
		  ret = scm_from_locale_string (c_ret);
		  LW6SYS_FREE (sys_context, c_ret);
  ...
  if (c_game_state)
    {
      ...
      c_timestamp = scm_to_long_long (timestamp);
      c_ret = lw6pil_pilot_new (c_game_state, c_seq_0, c_timestamp, &progress);
      if (c_ret)
	{
...
_scm_lw6pil_send_command (SCM pilot, SCM command_text, SCM verified)
{
  ...
  if (c_pilot)
      ...
      if (c_command_text)
	{
	  ...
	  ret = lw6pil_pilot_send_command (c_pilot, c_command_text, c_verified) ? SCM_BOOL_T : SCM_BOOL_F;
	  LW6SYS_FREE (sys_context, c_command_text);
	}
    }
  ...
  if (c_pilot)
    {
      ...
      if (c_command_text)
	{
	  ret = lw6pil_pilot_local_command (c_pilot, c_command_text) ? SCM_BOOL_T : SCM_BOOL_F;
	  LW6SYS_FREE (sys_context, c_command_text);
	}
    }
  ...
  if (c_game_state)
    {
      ...
      lw6pil_coords_fix (&(c_game_state->game_struct->rules), &shape, &c_x, &c_y, &c_z);
      ret =
	scm_list_3 (scm_cons
  ...
  if (c_game_state)
    {
      ...
      lw6ker_game_state_get_shape (sys_context, c_game_state, &shape);
      lw6pil_coords_fix_x10 (&(c_game_state->game_struct->rules), &shape, &c_x, &c_y, &c_z);
      ret =
	scm_list_3 (scm_cons
		    (scm_from_locale_string ("x"), scm_from_double (c_x)),
		    scm_cons (scm_from_locale_string ("y"), scm_from_double (c_y)), scm_cons (scm_from_locale_string ("z"), scm_from_double (c_z)));
  ...
  if (c_game_state)
    {
      ...
      if (c_command_text)
	{
	  ret = lw6pil_command_execute_text (NULL, 0LL, c_game_state, c_command_text, c_seq_0) ? SCM_BOOL_T : SCM_BOOL_F;
	  LW6SYS_FREE (sys_context, c_command_text);
	}
    }
...
_scm_lw6pil_local_cursors_set_main (SCM pilot, SCM cursor_id)
{
  ...
  if (c_pilot)
      ...
      if (c_cursor_id_str)
	{
	  ...
	  ret = lw6pil_local_cursors_set_main (lw6pil_pilot_get_local_cursors (c_pilot), c_cursor_id_int) ? SCM_BOOL_T : SCM_BOOL_F;
  ...
  if (c_pilot)
      ...
      if (c_cursor_id_str)
	{
	  ...
	  ret =
	    ...
	    (lw6pil_pilot_get_local_cursors (c_pilot), c_cursor_id_int, c_mouse_controlled) ? SCM_BOOL_T : SCM_BOOL_F;
	  LW6SYS_FREE (sys_context, c_cursor_id_str);
	}
    }
  ...
  if (c_target)
    {
      ...
      if (c_pilot)
	{
	  ret = lw6pil_pilot_sync_from_backup (c_target, c_pilot) ? SCM_BOOL_T : SCM_BOOL_F;
	}
    }
  ...
  if (c_target)
    {
      ...
      if (c_pilot)
	{
	  ret = lw6pil_pilot_sync_from_reference (c_target, c_pilot) ? SCM_BOOL_T : SCM_BOOL_F;
	}
    }
...
_scm_lw6pil_sync_from_draft (SCM target, SCM pilot, SCM dirty_read)
{
  ...
  if (c_target)
      ...
      if (c_pilot)
	{
	  ...
	  ret = lw6pil_pilot_sync_from_draft (c_target, c_pilot, c_dirty_read) ? SCM_BOOL_T : SCM_BOOL_F;
	}
    }
  ...
  if (c_pilot)
    {
      ...
      ret = scm_from_long_long (lw6pil_pilot_get_next_seq (c_pilot, c_timestamp));
    }
...
_scm_lw6pil_get_reference_current_seq (SCM pilot)
{
  ...
  if (c_pilot)
    {
      ret = scm_from_long_long (lw6pil_pilot_get_reference_current_seq (c_pilot));
    }
...
_scm_lw6pil_get_reference_target_seq (SCM pilot)
{
  ...
  if (c_pilot)
    {
      ret = scm_from_long_long (lw6pil_pilot_get_reference_target_seq (c_pilot));
    }
...
_scm_lw6pil_did_cursor_win (SCM pilot, SCM cursor_id)
{
  ...
  if (c_pilot)
	...
	{
	  ret = lw6pil_pilot_did_cursor_win (c_pilot, c_cursor_id_int) ? SCM_BOOL_T : SCM_BOOL_F;
	}
    }
...
_scm_lw6pil_suite_get_node_id (SCM node_index)
{
  ...
  c_ret = lw6sys_id_ltoa (sys_context, lw6pil_suite_get_node_id (c_node_index));
  if (c_ret)
    {
      ret = scm_from_locale_string (c_ret);
      LW6SYS_FREE (sys_context, c_ret);
...
_scm_lw6pil_suite_get_checkpoint (SCM stage)
{
  ...
  lw6pil_suite_get_checkpoint (&c_game_state_checksum, &c_seq, &c_round, c_stage);
...
lw6_register_funcs_pil ()
{
   ...
   * In liquidwar6pil
   */
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_BENCH, 0, 0, 0, (SCM (*)())_scm_lw6pil_bench);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SEED_COMMAND_GENERATE, 3, 0, 0, (SCM (*)())_scm_lw6pil_seed_command_generate);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_DUMP_COMMAND_GENERATE, 3, 0, 0, (SCM (*)())_scm_lw6pil_dump_command_generate);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_POLL_DUMP, 2, 0, 0, (SCM (*)())_scm_lw6pil_poll_dump);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_BUILD_PILOT, 3, 0, 0, (SCM (*)())_scm_lw6pil_build_pilot);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SEND_COMMAND, 3, 0, 0, (SCM (*)())_scm_lw6pil_send_command);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_LOCAL_COMMAND, 2, 0, 0, (SCM (*)())_scm_lw6pil_local_command);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_COMMIT, 1, 0, 0, (SCM (*)())_scm_lw6pil_commit);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_FIX_COORDS, 4, 0, 0, (SCM (*)())_scm_lw6pil_fix_coords);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_FIX_COORDS_X10, 4, 0, 0, (SCM (*)())_scm_lw6pil_fix_coords_x10);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_EXECUTE_COMMAND, 3, 0, 0, (SCM (*)())_scm_lw6pil_execute_command);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_LOCAL_CURSORS_SET_MAIN, 2, 0, 0, (SCM (*)())_scm_lw6pil_local_cursors_set_main);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_LOCAL_CURSORS_SET_MOUSE_CONTROLLED, 3, 0, 0, (SCM (*)())_scm_lw6pil_local_cursors_set_mouse_controlled);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_MAKE_BACKUP, 1, 0, 0, (SCM (*)())_scm_lw6pil_make_backup);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SYNC_FROM_BACKUP, 2, 0, 0, (SCM (*)())_scm_lw6pil_sync_from_backup);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SYNC_FROM_REFERENCE, 2, 0, 0, (SCM (*)())_scm_lw6pil_sync_from_reference);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SYNC_FROM_DRAFT, 3, 0, 0, (SCM (*)())_scm_lw6pil_sync_from_draft);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_CALIBRATE, 3, 0, 0, (SCM (*)())_scm_lw6pil_calibrate);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SPEED_UP, 2, 0, 0, (SCM (*)())_scm_lw6pil_speed_up);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SLOW_DOWN, 2, 0, 0, (SCM (*)())_scm_lw6pil_slow_down);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_ROUND_0, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_round_0);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_SEQ_0, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_seq_0);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SEQ2ROUND, 2, 0, 0, (SCM (*)())_scm_lw6pil_seq2round);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_ROUND2SEQ, 2, 0, 0, (SCM (*)())_scm_lw6pil_round2seq);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_NEXT_SEQ, 2, 0, 0, (SCM (*)())_scm_lw6pil_get_next_seq);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_LAST_COMMIT_SEQ, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_last_commit_seq);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_REFERENCE_CURRENT_SEQ, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_reference_current_seq);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_REFERENCE_TARGET_SEQ, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_reference_target_seq);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_MAX_SEQ, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_max_seq);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_IS_OVER, 1, 0, 0, (SCM (*)())_scm_lw6pil_is_over);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_DID_CURSOR_WIN, 2, 0, 0, (SCM (*)())_scm_lw6pil_did_cursor_win);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_WINNER, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_winner);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_GET_LOOSER, 1, 0, 0, (SCM (*)())_scm_lw6pil_get_looser);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SEQ_RANDOM_0, 0, 0, 0, (SCM (*)())_scm_lw6pil_seq_random_0);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SUITE_INIT, 1, 0, 0, (SCM (*)())_scm_lw6pil_suite_init);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SUITE_GET_SEQ_0, 0, 0, 0, (SCM (*)())_scm_lw6pil_suite_get_seq_0);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SUITE_GET_NODE_ID, 1, 0, 0, (SCM (*)())_scm_lw6pil_suite_get_node_id);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SUITE_GET_COMMANDS_BY_NODE_INDEX, 2, 0, 0, (SCM (*)())_scm_lw6pil_suite_get_commands_by_node_index);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SUITE_GET_COMMANDS_BY_STAGE, 1, 0, 0, (SCM (*)())_scm_lw6pil_suite_get_commands_by_stage);
  ret = ret && lw6scm_c_define_gsubr (LW6DEF_C_LW6PIL_SUITE_GET_CHECKPOINT, 1, 0, 0, (SCM (*)())_scm_lw6pil_suite_get_checkpoint);
