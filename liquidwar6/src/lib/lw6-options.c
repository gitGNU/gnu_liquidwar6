  ...
  for (i = 1; i < argc; ++i)
      ...
      else if (lw6sys_arg_match (LW6DEF_TEST, argv[i]))
	{
	  ...
	  if (log_file)
		...
		&& lw6glb_test (1)
		&& lw6map_test (1)
		&& lw6ker_test (1) && lw6pil_test (1) && DYN_TEST && lw6bot_test (1) &&
		lw6sim_test (1) && lw6cns_test (1)
      ...
      else if (lw6sys_arg_match (LW6DEF_CHECK, argv[i]))
	{
	  ...
	  if (log_file)
		...
		&& lw6glb_test (0)
		&& lw6map_test (0)
		&& lw6ker_test (0) && lw6pil_test (0) && DYN_TEST && lw6bot_test (0)
		&& lw6sim_test (0) && lw6cns_test (0)
