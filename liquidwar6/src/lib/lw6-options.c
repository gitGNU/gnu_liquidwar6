  ...
  if (ret)
      ...
      if (CU_initialize_registry () == CUE_SUCCESS)
	{
	  ret =
	    ...
	    && lw6tsk_test_register (mode) && lw6mat_test_register (mode)
	    && lw6gui_test_register (mode) && lw6vox_test_register (mode)
	    && lw6gfx_test_register (mode) && lw6dsp_test_register (mode)
	    && lw6snd_test_register (mode) && lw6img_test_register (mode)
	    && lw6net_test_register (mode) && lw6nod_test_register (mode)
	    && lw6cnx_test_register (mode) && lw6msg_test_register (mode)
	    && lw6cli_test_register (mode) && lw6srv_test_register (mode)
	    && lw6dat_test_register (mode) && lw6p2p_test_register (mode)
	    && lw6scm_test_register (mode) && lw6_test_register (mode);
