...
#define TEST_GAME_STRUCT_CHECKSUM 0x26ab79b7
#define TEST_GAME_STATE_CHECKSUM 0x88b7b6fa
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0x2c4ac4fd
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x4de48961
