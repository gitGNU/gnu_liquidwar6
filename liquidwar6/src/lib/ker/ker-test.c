...
#define TEST_GAME_STRUCT_CHECKSUM 0x112a81ea
#define TEST_GAME_STATE_CHECKSUM 0xca598c23
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0xcd388519
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x72bd7938
