...
#define TEST_GAME_STRUCT_CHECKSUM 0x517f38a1
#define TEST_GAME_STATE_CHECKSUM 0xe615eab2
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0xb2c98083
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x099d7d73
