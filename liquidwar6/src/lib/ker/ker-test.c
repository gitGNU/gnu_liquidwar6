...
#define TEST_GAME_STRUCT_CHECKSUM 0xdb63b40c
#define TEST_GAME_STATE_CHECKSUM 0x1658f664
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0x42849c55
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0xf9d061a5
