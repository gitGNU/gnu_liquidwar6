...
#define TEST_GAME_STRUCT_CHECKSUM 0x1a33a24d
#define TEST_GAME_STATE_CHECKSUM 0x705e1453
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0xd4a36654
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x0a1c5ffd
