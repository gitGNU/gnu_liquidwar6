...
#define TEST_GAME_STRUCT_CHECKSUM 0x018c464d
#define TEST_GAME_STATE_CHECKSUM 0xe5ae3295
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0x41534092
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x20fd0d0e
