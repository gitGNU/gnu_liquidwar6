...
#define TEST_GAME_STRUCT_CHECKSUM 0xdc2c5ef5
#define TEST_GAME_STATE_CHECKSUM 0xaab23e08
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0xadd33732
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x8337fe94
