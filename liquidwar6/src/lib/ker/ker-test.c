...
#define TEST_GAME_STRUCT_CHECKSUM 0x40a3da4b
#define TEST_GAME_STATE_CHECKSUM 0xc44ab06b
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0xc32bb951
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x6bdaf681
