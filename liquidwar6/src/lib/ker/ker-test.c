...
#define TEST_GAME_STRUCT_CHECKSUM 0x1acceb44
#define TEST_GAME_STATE_CHECKSUM 0x7d5f9990
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0x5bffe885
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x19b341ab
