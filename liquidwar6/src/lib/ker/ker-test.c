...
#define TEST_GAME_STRUCT_CHECKSUM 0xa2ada4fc
#define TEST_GAME_STATE_CHECKSUM 0x18c9f56e
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0x1fa8fc54
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0x48f30ea2
