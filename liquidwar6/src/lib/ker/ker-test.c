...
#define TEST_GAME_STRUCT_CHECKSUM 0x28e6fb93
#define TEST_GAME_STATE_CHECKSUM 0xbdc0fe85
#define TEST_GAME_STATE_POPULATE_CHECKSUM 0x193d8c82
#define TEST_GAME_STATE_ALGORITHM_CHECKSUM 0xc782b52b
