...
#define TEST_CONVERT_LONG_LONG 421421421421421LL
...
#define TEST_SHAPE_MIN_W 10
#define TEST_SHAPE_MIN_H 10
#define TEST_SHAPE_MIN_D 1
#define TEST_SHAPE_MAX_W 1000
#define TEST_SHAPE_MAX_H 1000
