...
lw6sys_list_free (lw6sys_list_t * list)
{
  if (list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("trying to free NULL list"));
    }
}
...
lw6sys_list_next (lw6sys_list_t * list)
{
  ...
  if (list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling next on NULL list"));
    }
...
lw6sys_list_is_empty (lw6sys_list_t * list)
{
  ...
  if (list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling is_empty on NULL list"));
    }
...
lw6sys_list_length (lw6sys_list_t * list)
{
  ...
  if (list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling length on NULL list"));
    }
		 ...
		 lw6sys_list_callback_func_t func, void *func_data)
{
  if (list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling map on NULL list"));
    }
}
...
lw6sys_list_push_front (lw6sys_list_t ** list, void *data)
{
  ...
  if (list && *list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling push_front on NULL list"));
    }
}
...
lw6sys_list_pop_front (lw6sys_list_t ** list)
{
  ...
  if (list && *list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling pop_front on NULL list"));
    }
...
lw6sys_list_push_back (lw6sys_list_t ** list, void *data)
{
  ...
  if (list && *list)
	...
	{
	  lw6sys_log (LW6SYS_LOG_WARNING, _("list push_back bug"));
	}
    }
  else
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling push_back on NULL list"));
    }
}
...
lw6sys_list_pop_back (lw6sys_list_t ** list)
{
  ...
  if (list && *list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling pop_back on NULL list"));
    }
...
lw6sys_list_dup (lw6sys_list_t * list, lw6sys_dup_func_t dup_func)
{
  ...
  if (list)
    ...
    {
      lw6sys_log (LW6SYS_LOG_WARNING, _("calling dup on NULL list"));
    }
