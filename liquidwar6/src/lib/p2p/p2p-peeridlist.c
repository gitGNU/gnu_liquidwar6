...
static void
_peer_id_list_process_join_callback (void *func_data, u_int64_t id)
{
...
void
_lw6p2p_peer_id_list_process_join (sys_context,_lw6p2p_node_t * node, lw6nod_info_t * remote_node_info)
{
